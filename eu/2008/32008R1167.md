---
celex: 32008R1167
nazev: "NAŘÍZENÍ RADY (ES) č. 1167/2008 ze dne 24. října 2008, kterým se mění a aktualizuje nařízení Rady (ES) č. 1334/2000, kterým se zavádí režim Společenství pro kontrolu vývozu zboží a technologií dvojího užití PŘÍLOHA"
druh: nařízení
cislo: 2008/1167
rok: 2008
eli: https://eur-lex.europa.eu/legal-content/CS/TXT/?uri=CELEX:32008R1167
tags:
  - eu
  - zruseno
  - nařízení
...
# NAŘÍZENÍ RADY (ES) č. 1167/2008 ze dne 24. října 2008, kterým se mění a aktualizuje nařízení Rady (ES) č. 1334/2000, kterým se zavádí režim Společenství pro kontrolu vývozu zboží a technologií dvojího užití PŘÍLOHA
...
325/1 
 ...
 Podle nařízení Rady (ES) č. 1334/2000 ( 1 ) má zboží dvojího užití (včetně softwaru a technologií) při vývozu ze Společenství podléhat kontrole. 
 ...
 Příloha I a příloha IV nařízení (ES) č. 1334/2000 by měly být změněny za účelem zohlednění změn přijatých v rámci Wassenaarského ujednání, Australské skupiny a Režimu kontroly raketových technologií v návaznosti na změny provedené v uvedených přílohách nařízením (ES) č. 1183/2007 ( 2 ) . 
 ...
 K usnadnění odkazů pro orgány vykonávající kontrolu vývozu a pro provozovatele by mělo být zveřejněno aktualizované a úplné znění příloh nařízení (ES) č. 1334/2000. 
...
## Článek 1
Přílohy nařízení (ES) č. 1334/2000 se nahrazují zněním obsaženým v příloze tohoto nařízení.
...
PŘÍLOHA
„PŘÍLOHA I
Seznam podle článku 3 nařízení Rady (ES) č. 1334/2000
...
d.
je vybaven „uživatelskou programovatelností“ prostřednictvím metody nauč/přehraj nebo prostřednictvím elektronického počítače, kterým může být programovatelná logická řídící jednotka, tj. bez mechanického zásahu.
POZN.: 
...
„Systematická chyba“ (gyroskop) (7): průměrná hodnota na výstupu gyroskopu za daný časový interval, která byla naměřena za konkrétních provozních podmínek a která není v korelaci s hodnotou na vstupu nebo s rotací. „Systematická chyba“ se obvykle vyjadřuje ve stupních za hodinu [deg/h]. (IEEE STD 528-2001).
„Systematická chyba“ (měřiče zrychlení) (7): průměrná hodnota na výstupu měřiče zrychlení za daný časový interval, která byla naměřena za konkrétních provozních podmínek a která není v korelaci s hodnotou na vstupu nebo s rotací. „Systematická chyba“ se vyjadřuje v [m/s 2 , g]. (IEEE STD 528-2001). (Mikrogram se rovná 1 × 10 –6 g).
...
b.
nastavením řídících funkcí zahrnujících zavádění parametrů.
...
AHRS
attitude and heading reference systems (referenční systém polohy a kursu)
AISI
...
AVLIS
atomic vapour laser isotope separation (izotopická separace atomových par za použití laseru)
CAD
...
CDU
control and display unit (řídící a zobrazovací jednotka)
CEP
circular error probable (kružnice stejné pravděpodobnosti)
CNTD
controlled nucleation thermal deposition (tepelný rozklad s řízenou tvorbou zárodku)
CRISLA
...
CVD
chemical vapour deposition (chemická depozice v parní fázi)
CW
chemical warfare (chemická válka)
(CW) (v případě laserů)
continuous wave (spojitá vlna)
DME
distance measuring equipment (zařízení pro měření vzdálenosti)
DS
directionally solidified (usměrněné tuhnutí)
EB-PVD
electron beam physical vapour deposition (fyzikální depozice v parní fázi elektronovým svazkem)
EBU
European Broadcasting Union
ECM
electro-chemical machining (elektrochemické obrábění)
ECR
electron cyclotron resonance (elektronová cyklotronová rezonance)
EDM
electrical discharge machines (elektrojiskrové obráběcí stroje)
EEPROMS
electrically erasable programmable read only memory (elektricky vymazatelná programovatelná permanentní paměť)
EIA
...
GLONASS
global navigation satellite system (globální systém družicové navigace)
GPS
global positioning system (globální polohovací systém)
HBT
hetero-bipolar transistors (heterobipolární tranzistory)
HDDR
high density digital recording (číslicový záznam vysoké hustoty)
HEMT
high electron mobility transistors (tranzistory s vysokou pohyblivostí elektronů)
ICAO
...
ILS
instrument landing system (systém přistávání podle přístrojů)
IRIG
Inter-range instrumentation group
ISA
Mezinárodní standardní atmosféra
ISAR
inverse synthetic aperture radar (radar s inverzní syntetickou aperturou)
ISO
International Organization for Standardization
ITU
International Telecommunication Union
JIS
Japanese Industrial Standard (japonská průmyslová norma)
JT
Joule-Thomson
LIDAR
light detection and ranging (laserový nebo světelný radar)
LRU
line replaceable unit (vyměnitelná jednotka)
MAC
message authentication code (autentizační kód zprávy)
Mach
ratio of speed of an object to speed of sound (after Ernst Mach) (poměr rychlosti objektu k rychlosti zvuku (podle Ernsta Macha))
MLIS
molecular laser isotopic separation (izotopická separace molekul za použití laseru)
MLS
microwave landing systems (mikrovlnné přistávací systémy)
MOCVD
metal organic chemical vapour deposition (chemická depozice v parní fázi za použití organokovových sloučenin
MRI
...
MTTF
mean-time-to-failure (střední doba provozu mezi poruchami)
NBC
Nuclear, Biological and Chemical (nukleární, biologický a chemický)
NDT
non-destructive test (zkouška bez porušení materiálu)
PAR
precision approach radar (přesný přibližovací radar)
PIN
personal identification number (osobní identifikační číslo)
ppm
parts per million (počet dílů na milion, ppm – odpovídá 1 × 10 –6 )
PSD
...
SC
single crystal (monokrystal)
SLAR
sidelooking airborne radar (radar s bočním vyzařováním)
SMPTE
Society of Motion Picture and Television Engineers
SRA
shop replaceable assembly (vyměnitelný celek)
SRAM
static random access memory (statická paměť s náhodným výběrem)
SRM
SACMA Recommended Methods (metody doporučené sdružením SACMA)
SSB
single sideband (jedno postranní pásmo)
SSR
secondary surveillance radar (sekundární přehledový radar)
TCSEC
trusted computer system evaluation criteria (kritéria pro hodnocení důvěryhodnosti počítačových systémů)
TIR
total indicated reading (celková výchylka měřicích hodin)
UV
ultraviolet (ultrafialový)
UTS
ultimate tensile strength (pevnost v tahu)
VOR
very high frequency omni-directional range (rozsah ultrakrátkých vln ve všech směrech)
YAG
yttrium/aluminium garnet (granát na bázi ytria a hliníku)
KATEGORIE 0
...
2.
jednostupňová nízkotlaká (tj. 0,2 MPa) radiální odstředivá dmychadla nebo kompresory pro cirkulaci plynného sirovodíku (tj. plynu obsahujícího více než 70 % H 2 S) s průtokem 56m 3 /s nebo vyšším při sacím tlaku 1,8 MPa nebo vyšším a opatřené ucpávkami pro provoz ve vlhkém H 2 S,
3.
...
1A003 Výrobky z nefluorinových polymerů uvedených v 1C008.a.3. ve formě fólií, desek, pásků nebo proužků, které mají některou z těchto vlastností:
a.
...
a.
bromobenzenacetonitrilu, bromobenzyl kyanidu (CA) (CAS 5798–79–8);
b.
o-chlorbenzylidenemalononitrilu (o-chlorbenzalmalononitrilu) (CS) (CAS 2698–41–1);
c.
2-chloro-1 fenylethanonu, ω-chloroacetofenonu (CN) (CAS 532–27–4);
d.
...
Poznámka: 
 ...
 V položce 1B001.b. se ‚řízenými střelami‘ rozumějí kompletní raketové systémy a systémy bezpilotních vzdušných dopravních prostředků.
c.
...
1.
pro koncentrované roztoky amidu draselného (1 % nebo více) je provozní tlak 1,5 až 60MPa nebo
2.
pro zředěné roztoky amidu draselného (méně než 1 %) je provozní tlak 20 až 60MPa.
...
2.
fluorované silikonové oleje s kinematickou viskozitou, měřenou při teplotě 289 K (25 °C), nižší než 5 000 mm 2 /s (5 000 cS);
c.
...
Poznámka 1: 
 ...
 Položka 1C008.a. zahrnuje látky v kapalné nebo pevné formě, včetně pryskyřice, prášku, pelet, filmu, listu, pásky nebo tkanice.
Poznámka 2: 
...
Technická poznámka:
‚Teplota skelného přechodu‘ (T g ) u materiálů uvedených v položce 1C008 se určuje metodou popsanou v normě ISO 11357-2 (1999) nebo podle odpovídajících národních norem.
...
Technická poznámka:
‚Teplota skelného přechodu‘ (T g ) u materiálů uvedených v položce 1C010.e. se stanoví suchou metodou popsanou v normě ASTM D 3418. ‚Teplota skelného přechodu‘ u fenolických a epoxidových pryskyřic se stanoví suchou metodou popsanou v normě ASTM D 4065 při frekvenci 1 Hz a rychlosti ohřevu 2 K (2 °C) za minutu.
...
1C101 Materiály a přístroje pro snížení rozpoznatelnosti, např. radarové odrazivosti, infračervené, ultrafialové a akustické rozpoznatelnosti, jiné než uvedené v položce 1C001, použitelné v ‚řízených střelách‘ podsystémech „řízené střely“ nebo v bezpilotních vzdušných dopravních prostředcích specifikovaných v položce 9A012.
Poznámka 1: 
...
polymerní látky:
1.
polybutadien s koncovou karboxy skupinou (včetně polybutadienu s koncovou karbosylovou skupinou) (CTPB),
2.
polybutadien s koncovou hydroxy skupinou (včetně polybutadienu s koncovou karbosylovou skupinou) (HTPB), jiný než uvedený v Seznamu vojenského materiálu,
3.
...
Poznámka 1: 
 ...
 Pokud jde o vývoz do „států, které nejsou stranami Úmluvy o zákazu chemických zbraní“, položka 1C350 nezahrnuje „směsi chemikálií“ obsahující jednu nebo více chemických látek uvedených v položce C350.1, .3, .5, .11, .12, .13, .17, .18, .21, .22, .26, .27, .28, .31, .32, .33, .34, .35, .36, .54, .55, .56, .57 a .63, ve kterých žádná uvedená chemikálie netvoří více než 10 % hmotnostních směsi.
Poznámka 2: 
...
Poznámka 1: 
 ...
 Pokud jde o vývoz do „států, které nejsou stranami Úmluvy zákazu o chemických zbraní“, položka 1C450 nezahrnuje „směsi chemikálií“ obsahující jednu nebo více chemických látek uvedených v podpoložkách 1C450.b.1., .b.2., .b.3., .b.4., .b.5. a .b.6., ve kterých žádná uvedená chemikálie netvoří více než 10 % hmotnostní směsi.
Poznámka 2: 
...
1D003 
 „Software“ speciálně konstruovaný nebo upravený tak, aby vybavení umožňovalo plnit funkce stanovené v položce 1A004.c.
1D101 
 „Software“ speciálně konstruovaný nebo upravený pro „použití“ zboží uvedeného v položkách 1B101.
1D103 
...
g.
‚knihovny (parametrické odborné databáze)‘ zvlášť navržené nebo upravené tak, aby vybavení umožňovaly plnit funkce uvedené v položce 1A004.c.
Technická poznámka:
...
5.
Jako alternativa jednotlivých protokolů o zkouškách může být pro každý model obráběcího stroje použita uváděná přesnost nastavení polohy odvozená z měření provedeného podle normy ISO 230/2(1988) ( 1 ) nebo odpovídajících národních norem. ‚Uváděnou přesností nastavení polohy‘ se rozumí hodnota přesnosti oznamovaná příslušným úřadům členského státu, ve kterém je vývozce usazen, jako přesnost konkrétního typu stroje.
...
f.
pokud má kterákoli osa typu stroje, na který se nevztahují položky 2B001.a. až 2B001.c. nebo 2B201, uváděnou přesnost Â 6mikronů u brusek a 8 mikronu u frézek a soustruhů nebo lepší, je výrobce povinen tuto hodnotu ověřovat každých osmnáct měsíců.
...
b.
stroje speciálně konstruované jako souřadnicové brusky, které nemají osu z nebo osu w, s přesností nastavení polohy při „všech dostupných kompenzacích“ menší (lepší) než 4 μm podle normy ISO 230/2 (1988) ( 1 ) nebo odpovídajících národních norem;
c.
rovinné brusky;
d.
...
3.
‚Konečná úprava pomocí energetických částicových paprsků‘ využívá plasmy reaktivních atomů 4. ‚Konečná úprava nafukovací membránou‘ je proces využívající tlakovou membránu, která provádí deformaci tak, aby kontakt s obrobkem nastal na malé ploše.
4.
...
2B003 
 „Číslicově řízené“ nebo ručně ovládané obráběcí stroje a jejich speciálně konstruované součásti, řídící prvky a příslušenství, speciálně konstruované pro ševingování, superfinišování, broušení nebo honování kalených (R c = 40 nebo více) čelních, šikmozubých nebo šípových ozubených kol s roztečným průměrem větším než 1 250 mm a šířkou kola nejméně 15 % roztečného průměru, dokončených na třídu jakosti AGMA 14 nebo lepší (odpovídající ISO 1328 třídě 3).
...
a.
počítačově řízené nebo „číslicově řízené“ souřadnicové měřicí stroje (CMM) s trojrozměrnou (volumetrickou) maximální povolenou chybou indikace (MPE E ) v jakémkoliv bodě měřicího rozsahu stroje (tj. podél celé délky měřených os) rovnou nebo lepší než (1,7 + L/1 000) μm (kde L je měřená délka v mm), zkoušeno podle normy ISO 10360-2 (2001);
POZN.: 
 VIZ TÉŽ 2B206.
b.
...
c.
měřicí systémy, mají splňují všechny tyto vlastnosti:
1.
obsahují „laser“ a
2.
...
Poznámka: 
 ...
 Položka 2B006.b.1. nezahrnuje měřicí interferometrové systémy, jež obsahují „laser“ pro měření odchylek pohybu saní obráběcích strojů, měřicích a kontrolních strojů nebo podobných zařízení a automatický řídící systém zkonstruovaný tak, aby nepoužíval žádné postupy zpětné vazby.
2.
...
2B007 
 „Roboty“, které mají speciálně konstruované řídící jednotky a „koncové efektory“ a některou z těchto vlastností:
POZN.: 
 VIZ TÉŽ 2B207.
a.
...
a.
vibrační testovací systémy používající techniky se zpětnou vazbou nebo uzavřenou smyčkou a zahrnující číslicovou řídící jednotku, schopné dosažení vibrací systému se zrychlením rovnajícím se nebo větším než 10 g rms mezi 20 Hz a 2 kHz a zároveň vyvozující síly rovnající se nebo větší než 50 kN, měřené na ‚holém stole‘;
b.
...
2B117 Zařízení a řídící systémy procesu, jiné než uvedené v položkách 2B004, 2B005.a., 2B104 nebo 2B105, konstruované nebo upravené pro zhušťování a pyrolýzu strukturních kompozitů raketových trysek a čelních štítů kosmických lodí pro návrat do atmosféry.
...
2B201 Obráběcí stroje a jakékoliv jejich kombinace iné než uvedené v položce 2B001, pro úběr nebo dělení kovů, keramiky nebo „kompozitů“, které mohou být podle technické specifikace výrobce vybaveny elektronickými zařízeními pro souvislou „interpolaci tvaru“ ve dvou nebo více osách:
a.
Obráběcí stroje pro frézování které mají některou z těchto vlastností:
1.
...
b.
zápustky, formy a řídící systémy speciálně konstruované pro „izostatické lisy“ uvedené v položce 2B204.a.
Technická poznámka:
...
2B207 
 „Roboty“, „koncové efektory“ a řídící kontrolní jednotky, jiné než uvedené v položce 2B007:
a.
...
b.
řídící jednotky speciálně konstruované pro kterýkoli z „robotů“ nebo „koncových efektorů“ uvedených v položce 2B207.a.
...
1.
využitelnou elektrodovou kapacitu 1 000 až 20 000 cm 3 a
2.
...
Uhlík s vlastnostmi diamantu (17)
B.3.
Fyzikální depozice v parní fázi (PVD): odpařování „laserem“
Keramika (19) a skla s nízkou roztažností (14)
Silicidy
Dielektrické vrstvy (15)
Uhlík s vlastnostmi diamantu (17)
...
6.
elektro-optické a „optické integrované obvody“ pro „zpracování signálů“, které mají všechny tyto vlastnosti:
a.
...
2.
mikrovlnné zesilovače výkonu s ‚monolitickými integrovaným obvody‘ (MMIC), které mají některou z těchto vlastností:
a.
...
Poznámka 1: 
 ...
 Položka 3A001.b.4 nezahrnuje rozhlasová a televizní satelitní zařízení konstruovaná nebo určená pro provoz ve frekvenčním rozsahu 40,5GHz až 42,5GHz.
Poznámka 2: 
...
5.
elektronicky nebo magneticky laditelné pásmové propusti nebo pásmové zdrže, které mají více než 5 laditelných rezonátorů s možností ladění 1,5:1 přes frekvenční pásmo (f max /f min ) za méně než 10 ìs a které mají některou z těchto vlastností:
a.
...
c.
„okamžitou šířku pásma“ větší než 1 oktáva (fmax > 2 fmin) a kteroukoliv z těchto vlastností:
1.
...
Technické poznámky:
1.
Pro výpočet objemu v položce 3A001.b.9.b., je poskytnut tento příklad: pro maximální jmenovitý výkon 20 W by objem činil: 20 W × 10 cm 3 /W = 200 cm 3 .
2.
...
disperzní zpoždění větší než 10 μs nebo
3.
potlačení postranních laloků frekvence větší než 55 dB a šířka pásma větší než 100 MHz;
2.
zařízení s prostorovou akustickou vlnou (tj. zařízení na „zpracování signálů“, která používají elastické vlny), jež umožňují přímé zpracování signálů při frekvencích větších 2,5 GHz,
3.
...
‚články‘:
a.
‚primární články‘, které mají ‚hustotu energie‘ 550 Wh/kg při 20 °C;
b.
...
2.
v ysokoenergetické akumulační kondenzátory:
POZN.: 
 VIZ TÉŽ 3A201.a.
a.
...
f.
snímače absolutní polohy se vstupem z otočného hřídele, které mají některou z těchto vlastností:
1.
...
5.
digitizéry vlnových průběhů a záznamníky přechodových dějů, které mají všechny tyto vlastností:
a.
rychlost digitalizace nejméně 200 milionů vzorků za sekundu a rozlišení rovnající se nebo větší než 10 bitů a
b.
...
d.
generátory signálů na bázi frekvenčních syntetizátorů, které produkují výstupní frekvence, jejichž přesnost a krátkodobá a dlouhodobá stabilita jsou řízeny vnitřním hlavním referenčním oscilátorem nebo jsou od něj odvozeny či upraveny, a které mají některou z těchto vlastností:
1.
...
3A003 Chladicí a rozprašovací tepelné řídící systémy využívající zařízení, které ovládá a upravuje oběh uzavřené tekutiny v utěsněném prostředí, přičemž dielektrická tekutina je rozprášená na elektronické součástky s použitím speciálně vyrobeného rozstřikovače, který udržuje v rámci operačního rozpětí teplotu elektronických součástek a zvlášť pro tento účel vyrobených součástí.
...
2.
V položce 3A102 se ‚řízenými střelami‘ rozumějí kompletní raketové systémy a systemy bezpilotních vzdušných dopravních prostředků s dosahem více než 300 km.
...
Q je rovno integrálu i podle t pro dobu méně než 1 μs nebo dobu trvání pulsu (Q = H idt), kde i je proud paprsku v ampérech a t je doba v sekundách.
2.
...
4.
energie paprsku 65 keV nebo více a paprskový proud 45 mA nebo více pro implantování kyslíku s vysokou energií do zahřáté „podložky“ z polovodičového materiálu;
c.
...
jsou konstruovaná nebo optimalizovaná pro tvorbu kritických rozměrů 180 nm nebo méně s přesností ±5 % 3 sigma nebo
b.
jsou konstruovaná pro generování méně než 0,04 částic/cm 2 s měřitelnou velikostí částic větší než 0,12 μm v průměru;
d.
...
—
Nástroje pro tiskovou litografii technikou 
 ‚Step and flash‘ (S-FIL) bavení pro tiskovou litografii schopné vyrábět struktury o velikosti 180 nm nebo menší;
3.
...
b.
mají některou z těchto vlasností:
1.
...
3D002 
 „Software“ speciálně konstruovaný pro „užití“ zařízení uvedeném v položce 3B001.a. až f. nebo v položce 3B002.
3D003 
 „Software“
...
Poznámka 2: 
 ...
 Řídící jednotky, které přímo propojují sběrnice nebo kanály základních jednotek, řídící jednotky „hlavní paměti“ nebo řídící jednotky diskové paměti se nepovažují za telekomunikační zařízení popsaná v kategorii 5 části 1 (Telekomunikace).
POZN.: 
...
„APP“ je nastavený nejvyšší výkon, při níž „digitální počítače“ provádějí 64bitové nebo větší sčítání a násobení s pohyblivou řádovou čárkou.
...
Poznámka 4: 
 ...
 Procesory, které jsou omezeny pouze na funkce vstupu/výstupu a periferní funkce (např. řídící jednotky disku, řadiče komunikačních a zobrazovacích jednotek) se do výpočtu „APP“ nezahrnují.
Poznámka 5: 
...
TECHNICKÁ POZNÁMKA KE „KORIGOVANÉMU ŠPIČKOVÉMU VÝKONU“ („APP“)
Poznámka 6: 
...
4.
radiová zařízení, která používají metody modulace ultra širokého pásma s uživatelsky programovatelnými kódy, utajovacími kódy nebo kódy pro identifikaci sítě, jež mají některou z těchto vlastností:
a.
...
f.
rušicí zařízení speciálně navržená nebo upravená tak, aby záměrně a selektivně rušila, odmítala, potlačovala, znehodnocovala nebo mátla telekomunikační služby telefonů, jež mají některou z těchto vlastností, a pro ně speciálně zkonstruované části:
1.
...
mobilní telekomunikace. 
 ...
 Pozn: Položka 5A001.g. nezahrnuje:
a.
...
a.
Zařízení a speciálně pro ně konstruované součásti nebo příslušenství, speciálně konstruované pro „vývoj“, „výrobu“ nebo „užití“ zařízení, funkcí nebo parametrů uvedených v položkách 5A001, 5B001, 5D001 nebo 5E001;
Poznámka: 
...
5D001 
 „Software“:
a.
„Software“ speciálně konstruovaný nebo upravený pro „vývoj“, „výrobu“ nebo „užití“ zařízení, funkcí nebo parametrů uvedených v položce 5A001 nebo 5B001;
b.
...
5E001
a.
„Technologie“ ve smyslu všeobecné poznámky k technologii pro „vývoj“„výrobu“ nebo „použití“ (kromě provozu) zařízení, funkcí nebo parametrů nebo „softwaru“ uvedených v položkách 5A001, 5B001 nebo 5D001.
b.
...
b.
pracují při vstupních nebo výstupních frekvencích vyšších než 31,8 GHz;
Poznámka: 
...
Poznámka 1: 
 ...
 Kontrolní status zařízení, „softwaru“, aplikačně specifických systémů „elektronických sestav“, modulů, integrovaných obvodů, součástí nebo funkcí zajišťujících „bezpečnost informací“ je vymezen v kategorii 5 části 2, a to i tehdy, pokud jsou součástmi nebo „elektronickými sestavami“ jiných zařízení.
Poznámka 2: 
...
a.
Zařízení speciálně konstruovaná pro „vývoj“ nebo „výrobu“ těchto zařízení nebo funkcí:
1.
„vývoj“ zařízení nebo funkcí uvedených v položkách 5A002, 5B002, 5D002 nebo 5E002, včetně měřicích nebo zkušebních zařízení,
2.
„výrobu“ zařízení nebo funkcí uvedených v položkách 5A002, 5B002, 5D002 nebo 5E002, včetně měřicích, zkušebních a opravárenských zařízení nebo zařízení pro „výrobu“;
b.
...
5D002 
 „Software“:
a.
„Software“ speciálně konstruovaný nebo upravený pro „vývoj“, „výrobu“ nebo „užití“ zařízení nebo „softwaru“ uvedených v položkách 5A002, 5B002 nebo 5D002;
b.
„software“ speciálně konstruovaný nebo upravený pro podporu „technologie“ uvedené v položce 5E002;
c.
Specifický „software“:
1.
„software“, který má vlastnosti nebo vykonává či simuluje funkce zařízení uvedených v položce 5A002 nebo položce 5B002,
2.
...
5E2 Technologie
5E002 
 „Technologie“ ve smyslu všeobecné poznámky k technologii pro „vývoj“, „výrobu“ nebo „užití“ zařízení nebo „softwaru“ uvedených v položkách 5A002, 5B002 nebo 5D002.
KATEGORIE 6
SNÍMAČE A LASERY
...
Poznámka: 
 ...
 Položka 6A001.a.1 nezahrnuje toto zařízení:
a.
...
měření hloubky vody;
b.
měření vzdálenosti ponořených nebo pohřbených předmětů nebo
c.
vyhledávání ryb.
Poznámka 2: 
...
c.
fotokatody z jiných „sloučenin skupin polovodičů III–V“;
Poznámka: 
...
elektronkového snímacího zařízení s roztečí nesloučených pixelů 500 µm nebo méně, speciálně navrženého nebo upraveného k dosažení ‚zesílení náboje‘ jiného než prostřednictvím mikrokanálové desky, a
3.
fotokatody ze „sloučenin skupin polovodičů III–V“ (například GaAs nebo GaInAs) nebo fotokatody na základě převedených elektronů;
Poznámka: 
 
 Položka 6A002.a.2.b.3. nezahrnuje fotokatody ze sloučenin polovodičů s maximální radiantovou citlivostí 15 mA/W nebo nižší.
c.
...
2.
jsou speciálně navržená nebo upravená k dosažení ‚zesílení náboje‘ a jejich maximální radiantová citlivost u vlnových déle nad 760 nm je vyšší než 10mA/W a
3.
...
b.
„ohnisková pole“ uvedená v položce 6A002.a.3.f;
c.
„ohnisková pole“ uvedená v položce 6A002.a.3.g nebo
d.
...
Poznámka 2: 
 ...
 Položka 6A003.b.4.a. nezahrnuje zobrazovací kamery obsahující lineární „ohnisková pole“ s nejvýše 12 prvky nebo méně, u nichž v prvku nedochází k časovému zpoždění integraci a které jsou, konstruované pro některý z těchto účelů:
a.
průmyslové nebo civilní poplašné systémy proti nežádoucímu vniknutí, systémy pro řízení provozu nebo průmyslové přepravy nebo počítací systémy;
b.
...
5.
Zobrazovací kamery obsahující detektory v pevné fázi uvedené v položce
...
2.
mající pásmové šířky pro směrování, sledování, stabilizaci nebo nastavení rezonátoru rovnající se nebo větší než 100 Hz a přesnost 10 μrad nebo menší,
3.
...
Poznámka 2: 
 ...
 Excimerové, polovodičové, chemické, CO, CO 2 a jednorázové impulsní Nd: skleněné „lasery“ jsou uvedeny pouze v položce 6A005.d.
Poznámka 3: 
 
 Položka 6.A005 zahrnuje vláknové „lasery“.
Poznámka 4: 
...
Poznámka 5: 
 ...
 Položka 6.A005 nezahrnuje tyto „lasery“:
a.
...
2.
výstupní vlnovou délku 150 nm nebo větší, ale nejvýše 520 nm, a vyšší než 30 W.
Poznámka: 
...
Poznámka: 
 ...
 Položka 6.A005.b.2.b. nezahrnuje argonové „lasery“, které mají „průměrný výstupní výkon“ rovný nebo menší než 50 W.
3.
výstupní vlnovou délku větší než 520 nm, ale nejvýše 540 nm a některou z těchto vlastností:
a.
výstup s jediným přechodovým módem a některou z těchto vlastností:
...
výstupní vlnovou délku větší než 800 nm, ale nejvýše 975 nm, a některou z těchto vlastností:
a.
„dobu trvání pulsu“ nejvýše 1 µs některou z těchto vlastností:
1.
...
3.
výstup s vícenásobným přechodovým módem „průměrný výstupní výkon“ vyšší než 50 W nebo
b.
...
b.
„dobu trvání pulsu“ delší než 1 ns, ale nejvýše 1 µs, a některou z těchto vlastností:
1.
výstup s jediným přechodovým módem a některou z těchto vlastností:
a.
...
Poznámka: 
 ...
 Položka 6.A005.c. zahrnuje titan-safír (Ti: Al2O3), thulium-YAG (Tm: YAG), thulium-YSGG (Tm: YSGG), alexandrit (Cr: BeAl2O4), „lasery“ s barevným středem, barvivové „lasery“ a kapalné „lasery“.
1.
...
6A006 
 „Magnetometry“, „magnetické gradiometry“, „gradiometry s vlastní magnetizací“ a podvodní snímače elektrického pole, a „vyrovnávací systémy“ a jejich speciálně konstruované součásti:
Poznámka: 
...
1.
používající „supravodivou“„technologii“ (SQUID) a mající některou z těchto vlastností:
a.
...
4.
„magnetometry“ s indukční cívkou, které mají „úroveň šumu“ (citlivost) nižší (lepší) než je některá z těchto hodnot:
a.
...
b.
Podvodní snímače eletrického pole s „úrovní šumu“ (citlivostí) nižší (lepší) než 8 nanovoltů na metr vztaženo na druhou odmocninu Hz při měření při 1 Hz;
c.
...
2.
přesnost určení polohy 1m nebo menší (lepší) při určení vzdálenosti, a 0,2 stupně nebo menší (lepší) při určení azimutu;
b.
...
6E201 
 „Technologie“ ve smyslu všeobecné poznámky k technologii pro „užití“ zařízení uvedených v položkách 6A003, 6A005.2., 6A005.b.2., 6A005.b.3., 6A005.b.4., 6A005.b.6., 6A005.c.2., 6A005.d.3.c., 6A005.d.4.c., 6A202, 6A203, 6A205, 6A225 nebo 6A226.
KATEGORIE 7
...
a.
„stabilita“„systematické chyby“, měřená v prostředí 1 g po dobu jednoho měsíce, a vztažená na pevnou kalibrační hodnotu: Menší (lepší) než 0,5 stupně za hodinu, jsou-li určeny pro provoz při hodnotách lineárního zrychlení do 100 g včetně;
b.
...
Technická poznámka:
‚gyroskopy s kroužící hmotou‘ gyroskopy, které používají neustále rotující hmotu pro snímání úhlového pohybu.
c.
Rozsah rychlosti otáčení (rate range) větší nebo rovný 500 stupňů na sekundu a mající některou z těchto vlastností:
1.
„stabilita“„sytematické chyby“, měřena v prostředí 1 g po dobu tří minut, a s ohledem na pevnou kalibrační hodnotu menší (lepší) než 40 stupňů za hodinu nebo
2.
...
1.
navržené pro navádění nebo přesné určení severu s přesností rovnající se nebo menší (lepší), než je 0,07 °/s (délka), které se rovnají 6 obloukovým minutám rms při 45 stupních zeměpisné šířky nebo
2.
...
b.
kapacita úhlové rychlosti podle jedné nebo více os při rychlosti rovnající se nebo větší než +2,62 rad/s (150°/s) nebo
c.
...
Poznámka: 
 ...
 Položka 7A101.a. nezahrnuje měřiče zrychlení speciálně konstruované a vyvinuté jako snímače MWD (systém měření během vrtání) k užití při obslužných pracích u hlubinných vrtů.
Technické poznámky:
1.
V položce 7A101.a. se ‚řízenou střelou‘ rozumí kompletní raketové systémy a systémy bezpilotních vzdušných dopravních prostředků s dosahem více než 300 km.
2.
V položce 7A101.a. měření „systematické chyby“ a „konstanty stupnice“ odkazuje ke standardní odchylce jedna sigma od pevné kalibrované hodnoty po dobu jednoho roku.
b.
...
1.
měřiče zrychlení uvedené v položkách 7A00.1a.3., 7A001.b. or 7A101 nebo gyroskopy uvedené v položkách 7A002 nebo 7A102 nebo
2.
měřiče zryclení uvedené v položce 7A001.a.1. nebo 7A001.a.2. a mající všechny tyto vlastnosti:
a.
...
Technická poznámka
2. V položce 7A103 se ‚řízenou střelou‘ rozumí kompletní raketové systémy a systémy bezpilotních vzdušných dopravních prostředků s dosahem více než 300 km.
...
3.
systémy řízení letu s přenosem řídících elektrických signálů po vodičích (fly-by-wire) nebo řídících světelných signálů po optických vláknech (fly-by-light),
4.
...
b.
„technologie“ pro „vývoj“„aktivních systémů řízení letu“ (včetně systémů řízení s přenosem řídících signálů po vodičích (fly-by-wire) nebo světelných signálů po optických vláknech (fly-by-light)):
1.
...
1.
víceosové ovládací zařízení s přenosem řídících elektrických signálů po vodičích (fly-by-wire) nebo světelných signálů po optických vláknech (fly-by-light), v nichž jsou spojeny funkce alespoň dvou z níže uvedených ovládacích prvků do jednoho ovládacího prvku:
a.
...
c.
‚dosah‘ 25 námořních mil nebo více a
d.
...
b.
systémy speciálně konstruované nebo upravené pro automatické řízení pohybu ponorných plavidel uvedených v položce 8A001 používající navigační údaje, a mající uzavřenou smyčku servořízení a některou z těchto vlastností:
1.
...
f.
elektronické zobrazovací systémy, speciálně konstruované nebo upravené pro použití pod vodou a schopné uchovávat číslicově více než 50 exponovaných obrazů;
Poznámka: 
 
 Položka 8A002.f. se nevztahuje na digitální kamery speciálně zkonstruované pro spotřební účely, jiné než ty, jež využívají postupů elektronického násobení obrazu.
g.
...
9A003 Speciálně konstruované montážní celky a součásti, které zahrnují některou z „technologií“ uvedených v položce 9E003.a., pro pohonné systémy s motory s plynovou turbínou, a které mají některou z následujících vlastností:
a.
...
2.
naváděcí nebo řídící systémy, jiné než uvedené v položce 7A, speciálně konstruované pro začlenění do „UAVs“ uvedené v položce 9A012.a.;
3.
...
b.
raketové, použitelné v „řízených střelách“, kosmických nosných prostředcích uvedených v položce 9A004 nebo v sondážních raketách uvedených v položce 9A104;
c.
...
9B002 On-line řídící systémy (v reálném čase), nástrojové vybavení (včetně snímačů), nebo zařízení pro automatizovaný sběr a zpracování dat, speciálně konstruované pro „vývoj“ motorů plynových turbín, montážních celků nebo součástí a obsahující „technologie“ uvedené v položce 9E003.a.
...
9B005 On-line řídící systémy (v reálném čase), nástrojové vybavení (včetně snímačů) nebo zařízení pro automatizovaný sběr a zpracování dat, speciálně konstruované pro užití s některými těmito zařízeními:
POZN.: 
 VIZ TÉŽ 9B105.
a.
aerodynamické tunely konstruované pro rychlosti 1,2 Mach nebo:
Poznámka: 
...
9D105 
 „Software“, kteŕy koordinuje funkce více než jednoho subsystému, speciálně konstruovaný nebo upravený pro „užití“ v kosmických nosných prostředcích uvedených v položce 9A004 nebo sondážních raketách uvedených v položce 9A104.
9E Technologie
Poznámka: 
...
POZN.: 
 ...
 Pro „technologie“ opravy konstrukcí, laminátů nebo materiálů podléhajících kontrole, viz 1E002.f.
...
4.
nechlazené turbínové lopatky, bandáže nebo jiné součásti, konstruované pro práci při celkových teplotách (teplotách stagnace) plynu v lopatkovém kanálu 1 323 K (1 050 ° C) nebo více;
5.
...
Poznámka 2: 
 ...
 Položka 9E003.a.10 nezahrnuje „technologii“ pro „vývoj“ nebo „výrobu“ proudového kanálu s nastavitelnou geometrií pro reverzní tah.
11.
...
9E101 
 „Technologie“ ve smyslu všeobecné poznámky k technologii pro „vývoj“ nebo „výrobu“ zboží uvedeného v položkách 9A101, 9A102, 9A104 až 9A111 nebo 9A115 až 9A119.
9E102 
 „Technologie“ ve smyslu všeobecné poznámky k technologii pro „užití“ kosmických nosných prostředků uvedených v položce 9A004 nebo zboží uvedeného v položkách 9A005 až 9A011, 9A101, 9A102, 9A104 až 9A111, 9A115 až 9A119, 9B105, 9B106, 9B115, 9B116, 9B117, 9D101 nebo 9D103.
„PŘÍLOHA II
...
Část 3
Toto vývozní povolení je platné po celém Společenství pro vývoz do těchto míst určení:
—
Austrálie
—
Kanada
...
č.
8. Země původu (v případě potřeby)
Kód ( 1 )
9. Dodavatelská země (v případě potřeby)
Kód ( 1 )
10. Konečný uživatel (je-li jiný než příjemce)
11. Členský stát současného nebo budoucího umístění položek
Kód ( 1 )
...
Vydávající orgán:
Datum
( 1 ) Viz nařízení (ES) č. 1172/95 ( Úř. věst. L 118, 25.5.1995, s. 10 ), ve znění pozdějších předpisů.
( 2 ) V případě potřeby je tento popis možné uvést na jedné nebo více přílohách k tomuto formuláři (1 a). V takovém případě uveďte v této kolonce přesný počet příloh.
EVROPSKÉ SPOLEČENSTVÍ
VÝVOZ ZBOŽÍ DVOJÍHO POUŽITÍ (Nařízení (ES) č. …)
1 a
POVOLENÍ
...
23. Čisté množství/hodnota (čistá hmotnost/jiná jednotka s označením jednotky)
24. V číslech
...
Zápisy nezahrnují úplný popis dotyčného zboží ani příslušné poznámky uvedené v příloze I ( 2 ) . Úplný popis zboží obsahuje pouze příloha I.
...
Poznámka: 
 ...
 Položka 1C101 nezahrnuje materiály formulované pouze pro civilní použití.
Technická poznámka:
V položce 1C101 se „řízenou střelou“ rozumí kompletní raketové systémy a systémy bezpilotních vzdušných dopravních prostředků s dosahem více než 300 km.
1D103
...
1C239
Vysoce účinné výbušniny, jiné než uvedené v Seznamu vojenského materiálu, nebo látky či směsi obsahující více než 2 % hmotnostní jakékoli výbušniny, které mají krystalickou hustotou vyšší než 1,8 g/cm 3 a detonační rychlost vyšší než 8 000 m/s.
1E201
...
POZN.: 
 VIZ TÉŽ SEZNAM VOJENSKÉHO MATERIÁLU.
3A232
Vícebodové rozbuškové sytémy jiné než uvedené v položce 1A007 výše:
POZN.: 
 VIZ TÉŽ SEZNAM VOJENSKÉHO MATERIÁLU.
3E201
...
systémy řízení vektoru tahu s pohyblivými tryskami nebo se sekundárním vstřikováním kapaliny, 
 ...
 , schopné provádět některou z těchto operací:
1.
pohyby ve všech směrech přesahující ±5°,
2.
otáčky úhlového vektoru 20°/s nebo více nebo
...
a.
raketové motory na kapalná paliva použitelné v „řízených střelách“, jiné než uvedené v položce 9A005, které mají celkovou kapacitu impulsu rovnající se nebo větší než 1,1 MNs 
 kromě motorů na kapalná paliva pro dosažení apogea, které jsou konstruovány nebo upraveny pro satelitní aplikace a mají všechny tyto vlastnosti 
 :
1.
...
Jednotlivé raketové stupně použitelné v kompletních raketových systémech nebo bezpilotních vzdušných dopravních prostředcích, 
 ...
 s dosahem 300 km, jiné než uvedené v položce 9A005 nebo 9A007.a. 
 výše 
 .
9B115
...
„Technologie“ ve smyslu všeobecné poznámky k technologii pro „vývoj“ zařízení nebo „softwaru“ uvedených v položkách 9A004, 9A005, 9A007.a., 9A008.d., 9B115, 9B116 nebo 9D101 
 ...
 .
9E002
„Technologie“ ve smyslu všeobecné poznámky k technologii pro „výrobu“ zařízení uvedených v položkách 9A004, 9A005, 9A007.a., 9A008.d., 9B115 nebo 9B116 
 výše 
 .
Poznámka: 
...
9E101
„Technologie“ ve smyslu všeobecné poznámky k technologii pro „vývoj“ nebo „výrobu“ zboží uvedeného v položkách 9A104, 9A105, 9A106.c., 9A108.c., 9A116 nebo 9A119 
 výše 
 .
9E102
...
1.
které jsou převáděny na základě objednávek Evropské kosmické agentury (ESA) nebo které tato agentura převádí za účelem splnění svých oficiálních úkolů;
2.
které jsou převáděny na základě objednávek kosmické organizace členského státu v rámci smluvního vztahu nebo které tato organizace převádí za účelem splnění svých oficiálních úkolů;
3.
které jsou převáděny na základě objednávek v rámci smluvního vztahu v souvislosti s některým vývojovým a výrobním programem Společenství pro vypouštění do kosmu, který podepsaly nejméně dvě evropské vlády;
4.
...
( 2 ) Rozdíly ve formulaci nebo působnosti mezi přílohou I a přílohou IV jsou označeny tučnou kurzívou.
