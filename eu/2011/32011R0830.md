---
celex: 32011R0830
nazev: "NAŘÍZENÍ KOMISE (EU) č. 830/2011 ze dne 27. července 2011, kterým se na rok 2011 stanoví „seznam Prodcom“ průmyslových výrobků zavedený nařízením Rady (EHS) č. 3924/91 PŘÍLOHA"
druh: nařízení
cislo: 2011/830
rok: 2011
eli: https://eur-lex.europa.eu/legal-content/CS/TXT/?uri=CELEX:32011R0830
tags:
  - eu
  - nařízení
  - rok/2011
---
# NAŘÍZENÍ KOMISE (EU) č. 830/2011 ze dne 27. července 2011, kterým se na rok 2011 stanoví „seznam Prodcom“ průmyslových výrobků zavedený nařízením Rady (EHS) č. 3924/91 PŘÍLOHA
...
224/1 
 ...
 NAŘÍZENÍ KOMISE (EU) č. 830/2011 
 ze dne 27. července 2011, 
 kterým se na rok 2011 stanoví „seznam Prodcom“ průmyslových výrobků zavedený nařízením Rady (EHS) č. 3924/91 
 ...
 Seznam Prodcom je nutno aktualizovat, a tudíž je nezbytné stanovit tento seznam na rok 2011. 
 ...
 Opatření stanovená tímto nařízením jsou v souladu se stanoviskem Výboru pro evropský statistický systém zřízeného nařízením Evropského parlamentu a Rady (ES) č. 223/2009 ze dne 11. března 2009 o evropské statistice ( 2 ) , 
...
## Článek 1
Seznam Prodcom na rok 2011 je uveden v příloze.
...
PRODCOM
Popis
Odkaz na nomenklaturu zahraničního obchodu za rok 2011
(HS/CN)
Jednotka
Objem
P
...
2511[.10 + .20] + 2528[.10 + .90] + 2529[.21 + .22] + 2530[.20 + .90]
kg
T
...
1602[.49(.11a + .13a + .15a + .19a + .30a + .90b)]
kg
S
10.13.15.85 z
...
1602[.90(.10b + .31b + .51a + .61b + .69b + .72b + .74b + .76a + .78a + .99a)]
kg
S
...
0303[.11 + .19 + .21(.10 + .20 + .80) + .22 + .29 + .31(.10 + .30 + .90) + .32 + .33 + .39(.10 + .30 + .70) + .41(.10 + .90) + .42(.12 + .18 + .42 + .48 + .90) + .43(.10 + .90) + .44(.10 + .90) + .45(.10 + .90) + .46(.10 + .90) + .49(.30 + .80) + .51 + .52(.10 + .30 + .90) + .61 + .62 + .71(.10 + .30 + .80) + .72 + .73 + .74(.30 + .90) + .75(.20 + .50 + .60 + .95) + .76 + .77 + .78(.11 + .12 + .13 + .19 + .90) + .79(.20 + .31 + .35 + .37 + .41 + .45 + .51 + .55 + .58 + .65 + .71 + .75 + .81 + .83 + .85 + .91 + .92 + .93 + .94 + .98)]
kg
S
10.20.13.60
...
10.20.14.00
Rybí filé, zmrazené
0304[.21 + .22 + .29(.01 + .03 + .05 + .13 + .15 + .17 + .18 + .21 + .29 + .31 + .33 + .35 + .39 + .41 + .43 + .45 + .51 + .53 + .55 + .56 + .58 + .59 + .61 + .65 + .68 + .71 + .73 + .75 + .79 + .83 + .85 + .91 + .99)]
kg
S
CPA 10.20.15: Rybí maso (též mleté), zmrazené
10.20.15.00
Rybí maso bez kostí (kromě filé), zmrazené
0304[.91 + .92 + .99(.10 + .21 + .23 + .29 + .31 + .33 + .39 + .41 + .45 + .51 + .55 + .61 + .65 + .71 + .75 + .99)]
kg
S
...
0305[.51(.10 + .90) + .59(.10 + .30 + .50 + .70 + .80) + .61 + .62 + .63 + .69(.10 + .30 + .50 + .80)]
kg
S
...
1604[.19(.10a + .31a + .39b + .50b + .92b + .93b + .94b + .95b + .98b)]
kg
S
10.20.25.90 z
Přípravky nebo konzervy z ryb (kromě celých nebo v kusech a hotových pokrmů)
1604[.20(.05b + .10b + .30a + .40b + .50a + .70a + .90b)]
kg
S
...
1605[.10(.00a) + .20(.10a + .91a + .99a) + .30(.10a + .90a) + .40(.00a) + .90(.11a + .19a + .30a + .90a)]
kg
S
...
2005[.91(.00a) + .99(.10a + .20a + .30a + .40a + .50a + .90a)]
kg
S
...
2001[.10 + .90(.10 + .20 + .30 + .40 + .50 + .60 + .65 + .70 + .91 + .97)]
kg
S
...
1102[.10 + .20(.10 + .90) + .90(.10 + .30 + .50 + .90)]
kg
S
...
kg
S
CPA 10.81.12: Třtinový nebo řepný cukr rafinovaný a chemicky čistá sacharosa, v pevném stavu, bez přídavku aromatických přípravků nebo barviv
10.81.12.30
...
1601[.00(.10b + .91a + .99a)] + 1602[.20(.10a + .90a) + .31(.11a + .19b + .30a + .90a) + .32(.11a + .19a + .30a + .90b) + .39(.21b + .29a + .40b + .80b) + .41 (.10a + .90b) + .42(.10b + .90a) + .49(.11b + .13b + .15b + .19b + .30b + .50b + .90a) + .50(.10a + .31a + .95a) + .90(.10a + .31a + .51b + .61a + .69a + .72a + .74a + .76b + .78b + .99b)]
kg
S
CPA 10.85.12: Hotové pokrmy z ryb, korýšů a měkkýšů
10.85.12.00 z
Hotové pokrmy z ryb, korýšů a měkkýšů
1604[.11(.00a) + .12(.10b + .91b + .99b) + .13(.11b + .19b + .90b) + .14(.11b + .16b + .18b + .90b) + .15(.11b + .19b + .90b) + .16(.00b) + .19(.10b + .31b + .39a + .50a + .91b + .92a + .93a + .94a + .95a + .98a) + .20(.05a + .10a + .30b + .40a + .50b + .70b + .90a)]
kg
S
CPA 10.85.13: Hotové pokrmy ze zeleniny
10.85.13.00 z
Hotové pokrmy ze zeleniny
2002[.10(.10b + .90b)] + 2003[.10(.20b + .30b) + .20(.00b) + .9 0(.00b)] + 2004[.90(.10b + .30b + .50b + .91b + .98b)] + 2005[.40(.00b) + .51(.00b) + .59(.00b) + .60(.00b) + .70(.00b) + .80(.00b) + .91(.00b) + .99(.10b + .20b + .30b + .40b + .50b + .60b + .90b)]
kg
S
...
2309[.90(.31f + .33f + .35e + .39f + .41e + .43b + .49e + .51d + .53e + .59a + .70b + .95e + .99d)]
kg
S
10.91.10.33 z
Krmiva průmyslová pro hospodářská zvířata (kromě premixů): prasata
2309[.90(.10d + .20c + .31c + .33d + .35b + .39d + .41f + .43c + .49d + .51c + .53a + .59b + .70c + .91d + .95d + .99b)]
kg
S
10.91.10.35 z
Krmiva průmyslová pro hospodářská zvířata (kromě premixů): hovězí dobytek
2309[.90(.10b + .20b + .31b + .33e + .35f + .39a + .41d + .43d + .49f + .51a + .53c + .59f + .70f + .91b + .95c + .99e)]
kg
S
10.91.10.37 z
Krmiva průmyslová pro hospodářská zvířata (kromě premixů): drůbež
2309[.90(.10a + .20d + .31e + .33c + .35c + .39e + .41c + .43e + .49c + .51e + .53b + .59e + .70a + .91a + .95a + .99c)]
kg
S
10.91.10.39 z
Krmiva průmyslová pro hospodářská zvířata (kromě premixů), ostatní
2309[.90(.10c + .20a + .31d + .33a + .35d + .39b + .41a + .43f + .49a + .51f + .53d + .59c + .70e + .91c + .95b + .99a)]
kg
S
...
2309[.90(.31a + .33b + .35a + .39c + .41b + .43a + .49b + .51b + .53f + .59d + .70d + .95f + .99f)]
kg
S
...
S
11.02.12.15
Vína révová nebo hroznový mošt, jehož kvašení bylo předem zabráněno nebo bylo zastaveno přidáním alkoholu, která mají při teplotě 20 °C p řetlak >= 1 bar a < 3 bary způsobený oxidem uhličitým (kromě šumivého vína)
...
S
11.02.12.20
Vína révová nebo hroznový mošt, jehož kvašení bylo předem zabráněno nebo bylo zastaveno přidáním alkoholu, s obsahem alkoholu s 15 % (kromě bílého a šumivého vína vqprd/jakostního vína s.o.)
...
5205[.11(.00c) + .12(.00a) + .13(.00c) + .14(.00c) + .15(.10a + .90b) + .31(.00a) + .32(.00b) + .33(.00c) + .34(.00a) + .35(.00b)] + 5206[.11(.00b) + .12(.00b) + .13(.00b) + .14(.00a) + .15(.00b) + .31(.00b) + .32(.00c) + .33(.00a) + .34(.00c) + .35(.00a)]
kg
T
13.10.61.33 z
...
5205[.11(.00b) + .12(.00c) + .13(.00b) + .14(.00a) + .15(.10c + .90a) + .31(.00b) + .32(.00a) + .33(.00b) + .34(.00c) + .35(.00a)] + 5206[.11(.00c) + .12(.00a) + .13(.00c) + .14(.00c) + .15(.00a) + .31(.00a) + .32(.00b) + .33(.00c) + .34(.00b) + .35(.00c)]
kg
T
13.10.61.35 z
...
5205[.11(.00a) + .12(.00b) + .13(.00a) + .14(.00b) + .15(.10b + .90c) + .31(.00c) + .32(.00c) + .33(.00a) + .34(.00b) + .35(.00c)] + 5206[.11(.00a) + .12(.00c) + .13(.00a) + .14(.00b) + .15(.00c) + .31(.00c) + .32(.00a) + .33(.00b) + .34(.00a) + .35(.00b)]
kg
T
13.10.61.52 z
...
5205[.21(.00b) + .22(.00a) + .23(.00b) + .24(.00b) + .26(.00b) + .27(.00b) + .28(.00b) + .41(.00b) + .42(.00c) + .43(.00b) + .44(.00a) + .46(.00b) + .47(.00c) + .48(.00c)] + 5206[.21(.00b) + .22(.00a) + .23(.00c) + .24(.00b) + .25(.00c) + .41(.00a) + .42(.00b) + .43(.00c) + .44(.00a) + .45(.00b)]
kg
T
13.10.61.53 z
Bavlněná příze z česaných vláken, neupravená pro maloobchodní prodej, pro pletené textilie a pro výrobu punčochového zboží
5205[.21(.00c) + .22(.00b) + .23(.00c) + .24(.00a) + .26(.00c) + .27(.00c) + .28(.00c) + .41(.00a) + .42(.00b) + .43(.00a) + .44(.00b) + .46(.00a) + .47(.00a) + .48(.00a)] + 5206[.21(.00a) + .22(.00b) + .23(.00b) + .24(.00a) + .25(.00a) + .41(.00c) + .42(.00c) + .43(.00b) + .44(.00c) + .45(.00a)]
kg
T
13.10.61.55 z
Bavlněná příze z česaných vláken, neupravená pro maloobchodní prodej, pro jiné použití (včetně koberců a podlahových krytin)
5205[.21(.00a) + .22(.00c) + .23(.00a) + .24(.00c) + .26(.00a) + .27(.00a) + .28(.00a) + .41(.00c) + .42(.00a) + .43(.00c) + .44(.00c) + .46(.00c) + .47(.00b) + .48(.00b)] + 5206[.21(.00c) + .22(.00c) + .23(.00a) + .24(.00c) + .25(.00b) + .41(.00b) + .42(.00a) + .43(.00a) + .44(.00b) + .45(.00c)]
kg
T
13.10.61.60
...
5208[.11(.90b) + .12(.16b + .19b + .96c + .99a) + .13(.00a) + .19(.00c) + .21(.90c) + .22(.16b + .19a + .96b + .99c) + .23(.00b) + .29(.00c) + .31(.00b) + .32(.16c + .19c + .96a + .99b) + .33(.00a) + .39(.00a) + .51(.00b) + .52(.00a) + .59(.10b + .90b)] + 5210[.11(.00b) + .19(.00b) + .21(.00b) + .29(.00b) + .31(.00a) + .32(.00c) + .39(.00a) + .51(.00c) + .59(.00c)] + 5212[.11(.10b + .90a) + .12(.10a + .90a) + .13(.10a + .90c) + .15(.10c + .90b)]
m 2
T
13.20.20.17 z
Bavlněné tkaniny, jiné než z různobarevných přízí, o hmotnosti <= 200 g/m 2 , pro domácí nebo bytový textil
5208[.11(.90a) + .12(.16a + .19a + .96a + .99c) + .13(.00b) + .19(.00b) + .21(.90b) + .22(.16a + .19b + .96a + .99b) + .2 3(.00a) + .29(.00a) + .31(.00c) + .32(.16b + .19a + .96b + .99a) + .33(.00b) + .39(.00b) + .51(.00a) + .52(.00b) + .59(.10a + .90c)] + 5210[.11(.00a) + .19(.00a) + .21(.00a) + .29(.00c) + .31(.00c) + .32(.00b) + .39(.00b) + .51(.00b) + .59(.00b)] + 5212[.11(.10a + .90c) + .12(.10b + .90b) + .13(.10c + .90a) + .15(.10a + .90c)]
m 2
T
13.20.20.19 z
...
5208[.11(.90c) + .12(.16c + .19c + .96b + .99b) + .13(.00c) + .19(.00a) + .21(.90a) + .22(.16c + .19c + .96c + .99a) + .23(.00c) + .29(.00b) + .31(.00a) + .32(.16a + .19b + .96c + .99c) + .33(.00c) + .39(.00c) + .51(.00c) + .52(.00c) + .59(.10c + .90a)] + 5210[.11(.00c) + .19(.00c) + .21(.00c) + .29(.00a) + .31(.00b) + .32(.00a) + .39(.00c) + .51(.00a) + .59(.00a)] + 5212[.11(.10c + .90b) + .12(.10c + .90c) + .13(.10b + .90b) + .15(.10b + .90a)]
m 2
T
13.20.20.20
...
5208[.41(.00b) + .42(.00a) + .43(.00b) + .49(.00d)] + 5209[.41(.00b) + .43(.00d) + .49(.00d)] + 5210[.41(.00d) + .49(.00d)] + 5211[.41(.00a)+.43(.00b)+.49(.10d+.90a)]
m 2
T
13.20.20.42 z
Bavlněné textilie o hmotnosti > 200 g/m 2 , jiné než z různobarevných přízí, pro oděvy
5209[.11(.00a) + .12(.00b) + .19(.00b) + .21(.00b) + .22(.00b) + .29(.00c) + .31(.00c) + .32(.00b) + .39(.00a) + .51(.00b) + .52(.00b) + .59(.00c)] + 5211[.11(.00c) + .12(.00c) + .19(.00c) + .20(.00c) + .31(.00c) + .32(.00a) + .39(.00c) + .51(.00a) + .52(.00c) + .59(.00c)] + 5212[.21(.10a + .90c) + .22(.10b + .90c) + .23(.10c + .90a) + .25(.10c + .90b)]
m 2
T
13.20.20.44 z
Bavlněné tkaniny, jiné než z různobarevných přízí, o hmotnosti > 200 g/m 2 , pro domácí nebo bytový textil
5209[.11(.00b) + .12(.00c) + .19(.00a) + .21(.00a) + .22(.00a) + .29(.00a) + .31(.00a) + .32(.00c) + .39(.00c) + .51(.00c) + .52(.00c) + .59(.00b)] + 5211[.11(.00b) + .12(.00b) + .19(.00b) + .20(.00a) + .31(.00b) + .32(.00b) + .39(.00b) + .51(.00c) + .52(.00a) + .59(.00a)] + 5212[.21(.10c + .90a) + .22(.10a + .90a) + .23(.10a + .90b) + .25(.10b + .90a)]
m 2
T
13.20.20.49 z
Bavlněné tkaniny o hmotnosti > 200 g/m 2 , jiné než z různobarevných přízí, pro technické a průmyslové použití
5209[.11(.00c) + .12(.00a) + .19(.00c) + .21(.00c) + .22(.00c) + .29(.00b) + .31(.00b) + .32(.00a) + .39(.00b) + .51(.00a) + .52(.00a) + .59(.00a)] + 5211[.11(.00a) + .12(.00a) + .19(.00a) + .20(.00b) + .31(.00a) + .32(.00c) + .39(.00a) + .51(.00b) + .52(.00b) + .59(.00b)] + 5212[.21(.10b + .90b) + .22(.10c + .90b) + .23(.10b + .90c) + .25(.10a + .90c)]
m 2
T
13.20.20.60
...
5208[.41(.00a) + .42(.00b) + .43(.00d) + .49(.00c)] + 5209[.41(.00a) + .43(.00a) + .49(.00a)] + 5210[.41(.00c) + .49(.00a)] + 5211[.41(.00c) + .43(.00d) + .49(.10b + .90b)] + 5212[.14(.10a + .90a) + .24(.10a + .90a)]
m 2
T
13.20.20.74 z
Bavlněné tkaniny z různobarevných přízí, pro domácí textilie a nábytkové potahové textilie
5208[.41(.00d) + .42(.00d) + .43(.00a) + .49(.00b)] + 5209[.41(.00c) + .43(.00c) + .49(.00b)] + 5210[.41(.00b) + .49(.00b)] + 5211[.41(.00b) + .43(.00c) + .49(.10c + .90d)] + 5212[.14(.10b + .90b) + .24(.10b + .90b)]
m 2
T
13.20.20.79 z
Bavlněné tkaniny z různobarevných přízí, pro technické a průmyslové použití
5208[.41(.00c) + .42(.00c) + .43(.00c) + .49(.00a)] + 5209[.41(.00d) + .43(.00b) + .49(.00c)] + 5210[.41(.00a) + .49(.00c)] + 5211[.41(.00d) + .43(.00a) + .49(.10a + .90c)] + 5212[.14(.10c + .90c) + .24(.10c + .90c)]
m 2
T
...
5801[.10 + .21 + .22 + .23 + .24 + .25 + .26 + .31 + .32 + .33 + .34 + .35 + .36 + .90(.10 + .90)]
m 2
S
...
p/st @
S
NACE 14.13: Fabrication de vêtements de dessus
...
6211[.41 + .42(.31 + .41 + .42 + .90) + .43(.31 + .41 + .42 + .90) + .49]
p/st @
S
14.19.22.30
...
6113[.00(.10+.90)] +6210[.10(.10+.90)+.20+.30+.40+.50]
p/st @
S
...
4302[.11 + .19(.10 + .20 + .30 + .41 + .49 + .50 + .60 + .70 + .95) + .20 + .30(.10 + .21 + .25 + .31 + .41 + .45 + .51 + .55 + .61 + .71 + .95)]
S
...
4407[.91(.15 + .39 + .90) + .92 + .93(.10 + .91 + .99) + .94(.10 + .91 + .99) + .95(.10 + .91 + .99) + .99(.20 + .25 + .40 + .91 + .96 + .98)]
m 3 @
S
16.10.10.71
...
—
S
CPA 16.29.14: Dřevěné rámy na obrazy, fotografie, zrcadla nebo podobné předměty a jiné dřevěné výrobky
16.29.14.10
...
S
17.12.42.60
Ostatní nenatíraný papír a lepenka, v kotoučích nebo listech, o plošné hmotnosti > 150 g/m 2 a < 225 g/m 2 (kromě výrobků z HS 4802 , papíru na zvlněnou vrstvu, testlineru, sulfitového balicího papíru, filtračního papíru nebo savého napouštěcího papíru a lep
4805 92
kg
S
17.12.42.80
...
17.12.78.20
Kraftový papír, karton a lepenka, natírané na jedné nebo na obou stranách kaolinem nebo jinou anorganickou látkou, v kotoučích nebo ve čtvercových nebo obdélníkových listech (arších), jakéhokoliv rozměru (jiné než určené ke psaní, tisku nebo k jiným grafi
4810 39
kg
S
17.12.78.50
...
2819[.10 + .90(.10 + .90)] + 2820[.10 + .90(.10 + .90)] + 2824[.10 + .90(.10 + .90)] + 2825.50
kg
T
...
2903[.41 + .42 + .43 + .44(.10 + .90) + .45(.10 + .15 + .20 + .25 + .30 + .35 + .40 + .45 + .50 + .55 + .90) + .46(.10 + .20 + .90) + .47 + .49(.11 + .15 + .19 + .20 + .30 + .40 + .80)]
kg
S
20.14.19.50
...
2932[.11 + .12 + .13 + .19 + .21 + .91 + .92 + .93 + .94 + .95 + .99]
kg
T
20.14.52.30
...
2707[.91 + .99(.11 + .19 + .30 + .50 + .70 + .91 + .99)]
kg
T
...
20.20.19.30
Zboží z HS 3808 , které obsahuje jednu nebo více z následujících látek: aldrin (ISO); binapakryl (ISO); kamfechlor (ISO) (toxafen); kaptafol (ISO); chlordan (ISO); chlordimeform (ISO); chlorbenzilát (ISO); DDT (ISO) (klofenotan (INN)), 1,1,1-trichlor-2,2-b
3808 50
kg act. Subst. @
S
20.20.19.80
...
kg
T
CPA 20.41.31: Mýdlo a organické povrchově aktivní prostředky a přípravky na bázi mýdla; papír, vata, plsť a netkané textilie, impregnované, natírané nebo potažené mýdlem nebo detergenty
20.41.31.20
...
—
S
CPA 20.42.15: Kosmetické přípravky, líčidla a přípravky pro péči o pokožku (včetně opalovacích a ochranných přípravků) j. n.
20.42.15.00
...
3702[.10 + .31(.20 + .91 + .98) + .32(.10 + .20 + .85) + .39 + .41 + .42 + .43 + .44 + .51 + .52 + .53 + .54 + .55 + .56 + .91(.20 + .80) + .93(.10 + .90) + .94(.10 + .90) + .95]
m 2 @
S
20.59.11.70
...
2937[.11 + .12 + .19 + .21 + .22 + .23 + .29 + .31 + .39 + .40 + .50 + .90]
g
S
...
2938[.10 + .90(.10 + .30 + .90)] + 2939[.11 + .19 + .20 + .30 + .41 + .42 + .43 + .49 + .51 + .59 + .61 + .62 + .63 + .69 + .91 + .99]
—
S
...
S
22.21.30.26
Pásky z polymerů propylenu o tloušťce > 0,10 mm a o šířce > 5 mm, avšak ≤ 20 mm, používané zejména pro balení (kromě samolepicích výrobků)
3920 20 80
kg
S
22.21.30.30
...
S
22.29.21.40
Samolepicí desky, listy, filmy, fólie, pruhy a pásky a jiné ploché tvary z plastů, v rolích o šířce s 20 cm (kromě pásků z plastů s vrstvou nevulkanizované přírodní nebo syntetické pryže)
3919 10 80
kg
S
CPA 22.29.22: Ostatní samolepicí desky, listy, filmy, fólie, pruhy a pásky a jiné ploché tvary z plastů
22.29.22.40
Samolepicí desky, listy, filmy, fólie, pruhy a pásky a jiné ploché tvary z plastů, též v rolích o šířce > 20 cm (kromě podlahových krytin, obkladů stěn a stropů čísla 3918 )
3919 90
kg
S
...
S
23.49.12.50 *
Keramické zboží, j.n. (kromě porcelánu)
6914 90
kg
S
...
7218[.10(.00b) + .99(.11b + .19a + .20b + .80a)]
kg
S
...
kg
S
CPA 24.10.36: Ploché válcované výrobky z ostatní legované oceli, po válcování za tepla již dále neopracované, o šířce < 600 mm (kromě výrobků z křemíkové elektrotechnické oceli)
24.10.36.00
...
7209[.15(.00a) + .16(.90a) + .17(.90b) + .18(.91a + .99a) + .25(.00a) + .26(.90a) + .27(.90a) + .28(.90a) + .90(.20b + .80b)]
kg
S
24.10.41.30 z
Plechy a pásy válcované za studena pro elektrotechnické účely, o šířce >= 600 mm, z nelegované oceli, finálně nežíhané
7209[.16(.90b) + .17(.90a) + .18(.91b + .99b) + .26(.90b) + .27(.90b) + .28(.90b) + .90(.20a + .80a)]
kg
S
24.10.41.50
...
kg
S
CPA 24.10.42: Plechy a pásy válcované za studena pro elektrotechnické účely, o šířce >= 600 mm, z nelegované oceli, s neorientovanou strukturou
24.10.42.00
...
S
24.10.66.50
Tyče válcované za tepla (kromě dutých vrtných tyčí), z legované oceli, jiné než nerezavějící, nástrojové, křemíko-manganové, ložiskové a rychlořezné oceli
...
7302[.10(.10 + .21 + .23 + .29 + .40 + .50 + .90) + .30 + .40 + .90]
kg
S
...
7220[.20(.21a + .29b + .41a + .49b + .81a + .89a) + .90(.20b + .80b)]
kg
S
24.32.10.22 z
...
7220[.20(.21b + .29a + .41b + .49a + .81b + .89b) + .90(.20a + .80a)]
kg
S
24.32.10.30
...
7212[.10(.90b) + .20(.00a) + .30(.00b) + .50(.20c + .30c + .40c + .90c)]
kg
S
24.32.20.30 z
...
7212[.10(.90a) + .30(.00a) + .50(.20b + .30a + .40b + .90b)]
kg
S
24.32.20.50 z
...
7212[.50(.20a + .30b + .40a + .61a + .69a + .90a)]
kg
S
24.32.20.60 z
...
p/st @
S
CPA 25.71.14: Stolní náčiní (včetně nožů na ryby a na máslo kromě stolních nožů), z nerezavějící oceli nebo jiných obecných kovů
25.71.14.30
...
25.73.50.13
Formovací rámy pro slévárny kovů, formovací základny,
8480[.10 +.20 +.30.90]
kg
S
25.73.50.15
...
S
25.92.12.40 *
Sudy, barely, plechovky, krabice a podobné nádoby, pro jakékoliv materiály (kromě stlačeného nebo zkapalněného plynu), j.n. (jiné než stlačitelné válcovité nádoby a nádoby na aerosoly)
7612 90 90
p/st @
S
25.92.12.60
...
7317[.00(.20 + .40 + .61 + .69 + .90)] + 7415.10 + 7616.10
kg
S
...
26.20.16.40
Tiskárny, kopírovací stroje a faxové přístroje, které je možno připojit k zařízení pro automatizované zpracování dat nebo do počítačové sítě (kromě tiskařských strojů a přístrojů určených k tisku pomocí tiskařských desek, válců a jiných tiskařských pomůce
...
26.20.40.00
Díly a příslušenství pro zařízení z HS 8471 ; díly a příslušenství vhodné i pro použití se stroji, přístroji nebo zařízeními dvou nebo více z HS 8469 až 8472
...
S
26.30.23.70
Ostatní přístroje pro vysílání nebo přijímání hlasu, obrazů nebo jiných dat, včetně přístrojů pro komunikaci v drátových nebo bezdrátových sítích (jako jsou lokální nebo dálkové sítě), jiné než vysílací nebo přijímací přístroje z HS 8443 , 8525 , 8527 nebo
...
S
26.30.40.60
Antény a díly vhodné pro použití výhradně nebo hlavně s přístroji z HS 8525 až 8528 , ostatní
8529[.10(.69 + .80 + .95)]
—
S
26.30.40.70
Skříně a pouzdra pro vysílací přístroje a přijímací zařízení pro rozhlasové nebo televizní vysílání, televizní kamery, atd.; díly vhodné pro použití výhradně nebo hlavně s televizními kamerami, přijímacím zařízením pro rozhlasové nebo televizní vysílání a
8529[.90(.41 + .49 + .92)]
—
S
S2
...
8528[.71(.90) + .72(.20 + .30 + .40 + .60 + .80) + .73]
p/st
S
...
S
26.51.51.79
Hydrometry, pyrometry, vlhkoměry a psychrometry jiné než elektronické (včetně hygrografů, termo hygrografů, termo-tlakových hygrografů, aktinometrů, pagoskopů; kromě radiosond na atmosférické sondování)
9025 80 80
p/st @
S
...
S
S2
CPA 26.51.82: Díly a příslušenství nástrojů a přístrojů z položek 26.51.12, 26.51.32, 26.51.33, 26.51.4 a 26.51.5; mikrotomy; díly j. n.
26.51.82.00
...
S
S2
CPA 26.51.84: Díly a příslušenství nástrojů a přístrojů z položek 26.51.63 a 26.51.64
26.51.84.33
...
S
S2
CPA 26.51.85: Díly a příslušenství nástrojů a přístrojů z položek 26.51.65, 26.51.66 a 26.51.70
26.51.85.20
Díly a příslušenství přístrojů, zařízení a strojů z HS 9031
9031[.90(.20 + .30 + .85)]
—
S
S2
...
S
S2
CPA 26.51.86: Díly a příslušenství nástrojů a přístrojů z položek 26.51.11 a 26.51.62
26.51.86.00
...
p/st
S
CPA 26.70.16: Kinematografické promítací přístroje; promítací přístroje pro diapozitivy; ostatní promítací přístroje pro statické snímky
26.70.16.00
...
9006[.61(.00a) + .69(.00b)] + 9008 40 00a + 9010[.10(.00a) + .50(.00a) + .60(.00a)]
—
S
...
S
S2
CPA 26.70.21: Polarizační materiál v listech nebo deskách; čočky, hranoly, zrcadla a jiné optické články (jiné než z opticky neopracovaného skla), též nezasažené, jiné než určené pro fotografické přístroje, promítací přístroje, zvětšovací nebo zmenšovací fotografické přístroje
26.70.21.53
...
S
S2
CPA 26.70.25: Díly a příslušenství zařízení s tekutými krystaly, laserů (kromě laserových diod) a ostatních optických přístrojů a zařízení
26.70.25.00
...
27.11.61.00
Díly určené výhradně nebo zejména ke strojům z HS 8501 nebo 8502
8503[.00(.10 + .91 + .99)]
—
S
S2
...
27.12.10.10
Jisticí přístroje pro napětí > 1 kV V
8535 10
p/st @
S
27.12.10.20
...
S
27.12.10.90
Ostatní přístroje ke spínání nebo ochraně elektrických obvodů pro napětí > 1000 V
8535 90
p/st @
S
...
27.40.41.00
Díly žárovek a výbojek z HS 8539
8539[.90(.10 + .90)]
—
S
S2
...
S
27.52.12.50
Železná nebo ocelová zařízení pro domácnost na kapalná paliva, včetně ohřívačů, krbů, kamen a koksových košů (kromě zařízení pro vaření a ohřívání talířů)
7321[.82(.10 + .90)]
p/st
S
27.52.12.70
...
p/st
S
CPA 27.52.13: Neelektrické ohřívače vzduchu a rozvodná zařízení horkého vzduchu, j.n.,
27.52.13.00
Neelektrické ohřívače vzduchu a rozvodná zařízení horkého vzduchu, j.n., ze železa nebo oceli
7322 90
p/st @
S
CPA 27.52.14: Neelektrické průtokové nebo zásobníkové ohřívače vody ze železa nebo oceli
27.52.14.00
...
S2
27.90.33.50
Díly přístrojů elektrických akustických nebo vizuálních signalizačních přístrojů, návěstných panelů, poplašných zařízení (HS 8531 )
8531[.90(.20 + .85)]
—
S
S2
...
—
S
CPA 27.90.40: Ostatní elektrická zařízení j. n. (včetně elektromagnetů; elektromagnetických spojek a brzd; elektromagnetických zdvihacích hlav; elektrických urychlovačů částic; generátorů signálů (měřicí vysílače) a strojů a přístrojů pro galvanické pokovování, elektrolýzu nebo elektroforézu)
27.90.40.10
Urychlovače částic
8543 10
kg
...
S
28.11.13.75
Pístové vznětové spalovací motory (dieselové motory nebo motory s žárovou hlavou) pro průmyslové užití, s výkonem > 1000 kW
8408[.90(.85 + .89)]
p/st
S
...
28.13.26.30
Pístové odsávací kompresory pracující s měrným přetlakem c<= 1,5 MPa (15 barů), s průtokem za hodinu <= 60 m 3
8414 80 22
p/st
S
28.13.26.50
...
28.14.20.00
Díly ventilů a podobných výrobků z HS 8481
8481 90
—
S
S2
...
28.29.39.10
Kontrolní váhy a automatická kontrolní zařízení použitelné do zatížení <= 5000 kg
8423[.81(.10) + .82(.10)]
p/st
S
28.29.39.30
...
p/st
S
CPA 28.92.26: Mechanické lopaty, rypadla a lopatové nakladače s nástavbou otočnou o 360°, s vlastním pohonem, kromě ě čelních lopatových nakladačů
28.92.26.00
...
S
28.95.11.50
Stroje na výrobu pytlů, sácků nebo obálek z papíru, kartonu nebo lepenky
8441 20
p/st @
S
28.95.11.60
...
S
28.95.11.70
Stroje na výrobu přědmëtů z buničiny, papíru, kartonu nebo lepenky tvarováním
8441 40
p/st @
S
28.95.11.90
...
p/st
S
CPA 28.99.20: Stroje a přístroje používané výhradně či převážně pro výrobu polovodičových materiálù nebo destiček, polovodičových zařízení, elektronických integrovaných obvodů nebo plochých panelových displejů
28.99.20.20
...
S
28.99.20.60
Stroje, přístroje a zařízení používaně výhradnë nebo hlavně pro výrobu plochých panelových displejů
8486[.30(.10 + .30 + .50 + .90)]
p/st @
S
...
p/st @
S
CPA 28.99.32: Kolotoče, houpačky, střelnice a ostatní pout'ové atrakce
28.99.32.00
...
S
28.99.39.20
Stroje a zařízení na montáž žá rovek nebo elektronových lamp, trubic, elektronek nebo výbojek nebo bleskových žárovek ve sklenëných pouzdrech
8475 10
p/st @
S
28.99.39.25
...
S
28.99.39.45
Stroje, přístroje a zařízení používané výhradně nebo hlavně pro a) výrobu nebo opravu masek a ohniskových destiček, b) montáž polovodičových soucástek nebo elektronických integrovaných obvodů, a c) zvedání, manipulaci, nakládání nebo vykládání ingotů (boules), destiček, polovodičových soucástek, elektronických integrovaných obvodů a plochých panelových displejů
8486 40
p/st @
S
28.99.39.50
...
M
28.99.39.70
Stroje k vyvažování mechanických soucástí
9031 10
kg
S
28.99.39.75
...
kg
S
CPA 28.99.40: Díly strojů a přístrojů pro tisk a knihvazačství
28.99.40.00
...
28.99.51.00
Díly strojů, přístrojů a zařízení používaných výhradně nebo hlavně pro a) výrobu polovodičových ingotů (boules) nebo destiček, polovodičových součástek, elektronických integrovaných obvodů nebo plochých panelových displejů, b) výrobu nebo opravu masek a o
8486[.90(.20 + .30 + .40 + .50 + .60 + .90)]
—
S
CPA 28.99.52: Díly ostatních strojů pro speciální účely
28.99.52.30
Díly strojů a zařízení na montáž žárovek nebo elektronových lamp, trubic, elektronek nebo výbojek nebo bleskových žárovek ve sklenëných pouzdrech, strojů na výrobu nebo opracování skla nebě skleněných výrobků za tepla
8475 90
—
S
S2
...
p/st
S
CPA 29.10.52: Vozidla konstruovaná pro jízdu na sněhu; na golfových h řištíc h apod., s motorem
29.10.52.00
...
p/st
S
CPA 29.10.59: Motorová vozidla pro zvláštní úcely j. n.
29.10.59.30
Požární automobily
8705 30
p/st
...
S
M
NACE 29.20: Výroba karoserií motorových vozidel; výroba přívésů a návěsů
...
S
29.20.22.30
Přívěsy o hmotnosti > 750 kg, ale <= 3 500 kg (včetně návësù typu karavan) (kromě stanových prívësù)
8716[.10(.94 + .96)]
p/st
S
29.20.22.50
Přívěsy o hmotnosti > 3 500 kg kg
8716 10 99
p/st
S
...
29.31.23.10
Světelné nebo vizuální signalizační zarízení pro jízdní kola
8512 10
p/st @
S
29.31.23.30
...
29.31.30.30
Části a součásti elektrického zapalovacího nebo spouštěcího zařízení, generátorů a regulačních spínačů používaných s tëmito motory
8511 90
—
S
S2
...
S
R O
CPA 30.11.32: Vlečná a tlačná plavidla
30.11.32.00
...
S2 M
30.30.50.50 *
Podvozky a jejich části a součásti pro vzducholodě, kluzáky, rogala a ostatní bezmotorové prostředky pro létání, vrtulníky, letouny, kosmické lodě a kosmické nosné rakety, pro civilní použitíå
8803 20
kg
S
S2 M
...
CPA 30.91.11: Motocykly a jízdní kola s pomocným vratným spalovacím pístovým motorem s vnitřním spalováním s obsahem válců ≤ 50 cm3
30.91.11.00
...
8711[.20(.10 + .91 + .93 + .98) + .30(.10 + .90) + .40 + .50]
p/st
S
...
8714[.92(.10 + .90) + .93(.10) + .94(.10 + .30) + .95 + .96(.10 + .30) + .99(.10 + .30 + .50)]
—
S
S2
...
31.00.11.50 *
Otáčivá sedadla, výškově nastavitelná (kromě zdravotnických, chirurgických, zubařských nebo veterinárních a křesel pro holičství a kadeřnictví)
9401 30
p/st @
S
31.00.11.70
...
S
32.50.13.70 *
Přístroje a zařízení pro lékařské, chirurgické a veterinární účely, j.n.
9018[.90(.75 + .84)]
p/st @
S
32.50.13.80
...
—
I
CPA 33.12.21: Opravy a údržba zemědělských a lesnických strojů a přístrojů
33.12.21.10
...
—
I
CPA 33.12.28: Opravy a údržba strojů a přístrojů na zpracování pryže a plastů
33.12.28.00
...
CPA 33.13.11: Opravy a údržba měřicích, zkušebních a navigačních nástrojů a přístrojů
33.13.11.10
...
—
I
CPA 33.20.41: Instalace lékařských strojů a přístrojů, přesných a optických přístrojů
33.20.41.00
...
7209[.15(.00b) + .16(.90c) + .17(.90c) + .18(.91c + .99c) + .25(.00b) + .26(.90c) + .27(.90c) + .28(.90c) + .90(.20c + .80c)] + 7219[.31 + .32(.10 + .90) + .33(.10 + .90) + .34(.10 + .90) + .35(.10 + .90) + .90(.20 + .80)] + 7225[.50(.20 + .80)]
kg
V
24.10.T3.20
...
1601[.00(.10 + .91 + .99)] + 1602[.20(.10 + .90) + .31(.11 + .19 + .30 + .90) + .32(.11 + .19 + .30 + .90) + .39(.21 + .29 + .40 + .80) + .41(.10 + .90) + .42(.10 + .90) + .49(.11 + .13 + .15 + .19 + .30 + .50 + .90) + .50(.10 + .31 + .95) + .90(.10 + .31 + .51 + .61 + .69 + .72 + .74 + .76 + .78 + .99)]
kg
S
10.00.00.Z2
Ryby, korýši, měkkýši a jiní vodní bezobratlí, jinak upravení nebo v konzervách, včetně hotových pokrmů
1604[.11 + .12(.10 + .91 + .99) + .13(.11 + .19 + .90) + .14(.11 + .16 + .18 + .90) + .15(.11 + .19 + .90) + .16 + .19(.10 + .31 + .39 + .50 + .91 + .92 + .93 + .94 + .95 + .98) + .20(.05 + .10 + .30 + .40 + .50 + .70 + .90)] + 1605[.10 + .20(.10 + .91 + .99) + .30(.10 + .90) + .40 + .90(.11 + .19 + .30 + .90)]
kg
S
10.00.00.Z3
Zelenina (kromě brambor), konzervovaná jinak než v octě nebo kyselině octové, včetně hotových pokrmů ze zeleniny
2002[.10(.10 + .90)] + 2003[.10(.20 + .30) + .20 + .90] + 2004[.90(.10 + .30 + .50 + .91 + .98)] + 2005[.40 + .51 + .59 + .60 + .70 + .80 + .91 + .99(.10 + .20 + .30 + .40 + .50 + .60 + .90)]
kg
S
10.90.10.Z0
...
S
39.99.00.Z5 *
Kolejový svrškový upevňovací materiál a upevňovací zařízení (kromě dřevěných, betonových a ocelových pražců, částí svršku a ještě nesmontovaného ostatního upevňovacího materiálu a materiálu pro stavbu železničních nebo tramvajových tratí); mechanické (též elektromechanické) přístroje návěstní, bezpečnostní, kontrolní, ovládací, pro železniční nebo jinou kolejovou dopravu, pro dopravu silniční nebo říční, pro parkoviště, pro přístavní nebo letištní zařízení; jejich části a součásti
8608
S
S2
*
=
Změněná položka oproti Seznamu 2010
@
=
Měrná jednotka odlišná od jednotky v CN
¤
=
Změna popisu oproti Seznamu 2010
