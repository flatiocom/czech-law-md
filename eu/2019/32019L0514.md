---
celex: 32019L0514
nazev: "SMĚRNICE KOMISE (EU) 2019/514 ze dne 14. března 2019, kterou se mění směrnice Evropského parlamentu a Rady 2009/43/ES, pokud jde o seznam produktů pro obranné účely PŘÍLOHA"
druh: směrnice
cislo: 2019/514
rok: 2019
eli: https://eur-lex.europa.eu/legal-content/CS/TXT/?uri=CELEX:32019L0514
tags:
  - eu
  - směrnice
  - rok/2019
---
# SMĚRNICE KOMISE (EU) 2019/514 ze dne 14. března 2019, kterou se mění směrnice Evropského parlamentu a Rady 2009/43/ES, pokud jde o seznam produktů pro obranné účely PŘÍLOHA
...
89/1 
 ...
 Dne 26. února 2018 přijala Rada aktualizovaný Společný vojenský seznam Evropské unie ( 2 ) . 
...
## Článek 2
1. Členské státy přijmou a zveřejní právní a správní předpisy nezbytné pro dosažení souladu s touto směrnicí do 30. června 2019. Neprodleně sdělí Komisi jejich znění.
Použijí tyto předpisy ode dne 5. července 2019.
...
d.
pušky nebo ruční střelné zbraně speciálně určené k vystřelení inertní střely pomocí stlačeného vzduchu nebo CO 2 ;
b.
...
2.
O-alkyl(H nebo ≤ C 10 včetně cykloalkyl)-O-2-N,N- dialkyl(methyl, ethyl, n- propyl nebo i-propyl)aminoethyl-alkyl(methyl, ethyl, npropyl nebo i-propyl)fosfonity a odpovídající alkylované a protonované soli, např.:
...
nepoužívá se od roku 2013;
3.
„hnací hmoty“ s měrnou energií větší než 1 200 kJ/kg;
4.
...
b.
jiná paliva a palivová aditiva s vysokou energetickou hustotou (např. kuban, iontové roztoky, JP-7, JP-10) s energetickou hustotou vyjádřenou na základě objemu v hodnotě 37,5 GJ/m3 nebo vyšší, měřeno při teplotě 293 K (20 °C) a tlaku jedné atmosféry (101,325 kPa);
Poznámka:
11.
...
b.
směsi hořčíku, polytetrafluorethylenu (PTFE) a některého kopolymeru vinyliden-hexafluoropropylendifluoridu (např. MTV);
12.
...
5.
HAN (hydroxylamoniumnitrát) (CAS 13465-08-2);
6.
HAP (chloristan hydroxylaminu, hydroxylamoniumchloristan) (CAS 15588-62-2);
7.
HNF (hydrazinium nitroformat, nitromravenčan hydrazinia) (CAS 20773-28-8);
8.
dusičnan hydrazinu, hydrazinnitrat (CAS 37836-27-4);
9.
chloristan hydrazinu, hydrazinchloristan (CAS 27978-54-7);
10.
...
2.
BAMO (3,3-bis(azidomethyl)oxetan a jeho polymery) (CAS 17607-20-4) (viz také jeho „prekurzory“ uvedené pod bodem ML8 g) 1.);
3.
...
13.
poly(epichlorhydrin) s funkčností alkoholových skupin o nízké molekulové hmotnosti (méně než 10 000), takto:
a.
...
5.
beta-resorcylát olova (CAS 20936-32-7) nebo beta-resorcylát mědi (CAS 70983-44-7);
6.
...
11.
MAPO (tris-1-(2-methyl)aziridinylfosfinoxid) (CAS 57-39-6); BOBBA 8 (bis(2-methylaziridinyl) 2-(2-hydroxypropanoxy)-propylaminofosfinoxid) a další MAPO deriváty;
12.
...
a.
neopentyl (diallyl) oxy, tri (dioktyl) titanfosfát (CAS 103850-22-2); známý také jako titanium IV, 2,2(bis 2-propenolatomethyl, butanolato, tris (dioktyl) fosfát) (CAS 110438-25-0); nebo LICA 12 (CAS 103850-22-2);
b.
titanium IV, (2-propenolato-1) methyl, n-propanolatomethyl) butanolato-1, tris(dioktyl)pyrofosfát, nebo KR3538;
c.
...
19.
superjemný oxid železa (Fe 2 O 3 ) (CAS 1317-60-8) se specifickým povrchem větším než 250 m 2 /g a s průměrnou velikostí částic 3,0 nm nebo menší;
20.
...
POZN.
1.
BCMO (3,3-bis(chlormethyl)oxetan) (CAS 78-71-7) (viz také bod ML8 e) 1. a e) 2.);
2.
...
nepoužívá se od roku 2013;
5.
TAT (1,3,5,7-tetraacetyl-1,3,5,7-tetraazacyklooktan (CAS 41378-98-7) (viz také bod ML8 a) 13.);
6.
...
1.
prášek následujících materiálů s velikostí částice v kterémkoli směru nižší než 250 μm a neuvedený jinde v bodě ML8:
a.
hliník;
b.
niob;
...
Technické poznámky
1.
‚Reaktivní materiály‘ jsou speciálně určené k vyvolání exotermické reakce pouze při vysoké smykové rychlosti a k použití jako vnitřní vystýlky nebo pláště hlavic.
2.
Prášek ‚reaktivních materiálů‘ je vyroben například postupem kulového mletí, při němž se vytváří vysoká energie.
3.
...
Technická poznámka
‚Na vzduchu nezávislý pohonný systém‘ (AIP) umožňuje, aby u ponořené ponorky fungoval pohonný systém bez přístupu k atmosférickému kyslíku po delší dobu, než by jinak dovolovaly baterie. Pro účely bodu ML9 b) 4. AIP nezahrnuje pohon využívající jadernou energii;
c.
...
c.
byly úřady civilního letectví jednoho nebo více členských států EU nebo signatářských zemí Wassenaarského ujednání schváleny k civilnímu provozu.
Poznámka 2:
a.
...
b.
neobsahují položky uvedené ve Společném vojenském seznamu EU, ledaže jsou takové položky nezbytné pro požadavky na bezpečnost nebo letovou způsobilost stanovené úřady civilního letectví jednoho nebo více členských států EU nebo signatářských zemí Wassenaarského ujednání, a
c.
...
2.
podvodní plovací přístroj speciálně určený pro použití s potápěcím přístrojem uvedeným v bodě ML 17 a) 1.;
POZN.
b.
...
l.
intermodální kontejnery ISO nebo výměnné nástavby vozidel (swap bodies) speciálně určené nebo ‚upravené‘ pro vojenské použití;
m.
...
a.
speciálně určené nebo upravené ‚výrobní‘ zařízení sloužící k ‚výrobě‘ výrobků zahrnutých ve Společném vojenském seznamu EU a pro ně speciálně určených součástí;
b.
...
f.
dražovací bubny s průměrem minimálně 1,85 m a s kapacitou větší než 227 kg;
g.
kontinuální mísiče pevných „hnacích hmot“;
h.
fluidní mlýny pro mletí a drcení složek vojenských „výbušnin“;
i.
...
c.
radiofrekvenční vysílače s vysokým impulsním nebo průměrným výkonem, které vytvářejí pole dostatečně silná ke zneschopnění elektronických obvodů vzdáleného cíle.
Poznámka 2:
a.
...
h.
součásti urychlovačů „vhodné pro kosmické aplikace“;
i.
vybavení k zaostřování paprsků záporných iontů;
j.
vybavení pro řízení a směrování vysokoenergetického paprsku iontů;
k.
fólie „vhodné pro kosmické aplikace“, které slouží k neutralizaci paprsků se zápornými ionty vodíku.
ML20 
