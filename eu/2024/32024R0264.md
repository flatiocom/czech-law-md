---
celex: 32024R0264
nazev: "NAŘÍZENÍ KOMISE (EU) 2024/264 ze dne 17. ledna 2024, kterým se mění nařízení Evropského parlamentu a Rady (ES) č. 1099/2008 o energetické statistice, pokud jde o provádění aktualizací pro roční, měsíční a krátkodobé měsíční energetické statistiky PŘÍLOHA"
druh: nařízení
cislo: 2024/264
rok: 2024
eli: https://eur-lex.europa.eu/legal-content/CS/TXT/?uri=CELEX:32024R0264
tags:
  - eu
  - nařízení
  - rok/2024
---
# NAŘÍZENÍ KOMISE (EU) 2024/264 ze dne 17. ledna 2024, kterým se mění nařízení Evropského parlamentu a Rady (ES) č. 1099/2008 o energetické statistice, pokud jde o provádění aktualizací pro roční, měsíční a krátkodobé měsíční energetické statistiky PŘÍLOHA
...
Série L 
 ...
 s ohledem na nařízení Evropského parlamentu a Rady (ES) č. 1099/2008 ze dne 22. října 2008 o energetické statistice ( 1 ) , a zejména na čl. 4 odst. 3, čl. 5 odst. 3 a čl. 9 odst. 2 uvedeného nařízení, 
 ...
 Rychlé tempo technologického pokroku, vývoj energetických politik Unie a rovněž potřeba, aby cíle Unie a sledování jejich dosahování vycházely z oficiálních energetických údajů, vyžadují, aby energetické statistiky byly pravidelně přezkoumávány. Proto se musí evropský rámec pro vykazování energetických statistik pravidelně aktualizovat, aby odrážel narůstající nebo měnící se potřeby. 
 ...
 Používání spolehlivých, vysoce kvalitních energetických statistik ke sledování dosahování cílů politik v rámci Zelené dohody pro Evropu, balíčku k dosažení 55% snížení emisí (Fit for 55) a energetických balíčků Unie by mělo posílit důvěryhodnost energetické politiky Unie. 
 ...
 Komise určila několik aspektů ročních, měsíčních a krátkodobých měsíčních energetických statistik, které je třeba aktualizovat. Týkají se zejména dodatečných výkaznických povinností, pokud jde o vodík a jeho vztah k jiným palivům, které podávají komplexnější přehled o vodíkovém hospodářství; definic jaderného průmyslu a používání černého uhlí, které lépe objasňují vykazované údaje; změny v kategoriích obsahu síry v topném oleji podle mezinárodních klasifikací a dalších podrobností týkajících se vykazování v souvislosti s hydroelektrickou energií, které zlepšují posuzování tohoto zdroje energie. 
...
Vypočítaná hodnota, definovaná jako rozdíl mezi výpočtem z hlediska dodávek (přístup „shora dolů“) a výpočtem z hlediska spotřeby (přístup „zdola nahoru“). Vykazující země by měly objasnit všechny významné statistické rozdíly.
...
Množství kapalných biosložek smísených s fosilními palivy. Množství vodíku smíseného s palivy.
2.2.18. VÝROBA VODÍKU
Množství paliv použitá na výrobu vodíku.
2.2.19. JINDE NEUVEDENÉ
...
Množství spotřebovaná energetickým průmyslem na podporu těžby (dobývání, produkce ropy a plynu) nebo zařízení s činností související s transformací paliv a energie. V rámci NACE odpovídá oddílům 05, 06, 19 a 35, skupině 09.1 a třídám 07.21 a 08.92.
...
2.3.6. PLYNÁRNY / ZAŘÍZENÍ NA ZPLYŇOVÁNÍ UHLÍ (ZPLYŇOVACÍ ZAŘÍZENÍ)
...
2.3.14. JADERNÝ PRŮMYSL
Množství paliv spotřebovaná jako energie pro podpůrné činnosti v jaderném průmyslu (těžba, zpracování, přepracování jaderného materiálu pro jaderné štěpení a jadernou fúzi) a včetně úpravy, odstraňování a skladování radioaktivního jaderného odpadu.
2.3.15. TĚŽBA ROPY A PLYNU
...
2.3.16. VÝROBA, ZKAPALŇOVÁNÍ A ZPLYŇOVÁNÍ VODÍKU
Množství paliv spotřebovaná jako energie na podporu výroby, zkapalňování a zplyňování vodíku.
2.3.17. JINDE NEUVEDENÉ – ENERGIE
...
Množství paliv použitá pro neenergetické účely – nespálených paliv.
...
Množství paliv spotřebovaná podniky a úřady ve veřejném a soukromém sektoru. Oddíly 33, 36, 37, 38, 39, 45, 46, 47, 52, 53, 55, 56, 58, 59, 60, 61, 62, 63, 64, 65, 66, 68, 69, 70, 71, 72, 73, 74, 75, 77, 78, 79, 80, 81, 82, 84 (kromě třídy 84.22), 85, 86, 87, 88, 90, 91, 92, 93, 94, 95, 96 a 99 NACE. Paliva použitá na vytápění a osvětlení na železničních a autobusových nádražích, v přístavištích a na letištích by se měla uvést v této kategorii. Zahrnuje paliva použitá pro všechny činnosti nesouvisející s dopravou v oddílech 49, 50 a 51 NACE.
2.6.3.1.1.
2.6.3.1.2.
2.6.3.1.3.
2.6.3.1.3.1.
...
2.6.3.1.16.
2.6.3.2. Domácnosti
Množství paliv spotřebovaná všemi domácnostmi včetně „domácností jako zaměstnavatelů domácího personálu“. oddíly 97 a 98 NACE.
...
2.6.3.3. Zemědělství
Množství paliv spotřebovaná uživateli zatříděnými jako rostlinná a živočišná výroba, myslivost a související činnosti; oddíl 01 NACE.
2.6.3.4. Lesnictví
Množství paliv spotřebovaná uživateli zatříděnými jako lesnictví a těžba dřeva; oddíl 02 NACE.
2.6.3.5. Rybolov
Množství paliv dodaná pro vnitrozemský, pobřežní a hlubinný rybolov. Rybolov by měl zahrnovat paliva dodaná lodím všech vlajek, které doplnily palivo v dané zemi (včetně mezinárodního rybolovu), a energii použitou v odvětví rybolovu. oddíl 03 NACE.
2.6.3.6. Jinde neuvedené – Ostatní
Množství paliv použitá pro činnosti jinde nezahrnuté (např. třída 84.22 NACE). Tato kategorie zahrnuje palivo použité pro vojenské účely v rámci veškeré mobilní a stacionární spotřeby (např. lodě, letadla, silniční vozidla a energie použitá v obytných prostorách) bez ohledu na to, zda palivo bylo dodáno armádě dané země nebo armádě jiné země. V případě použití je třeba ve zprávě vysvětlit, co je zahrnuto v této položce.
3. PRODUKTY
...
Syntetická surová ropa z dehtových písků, břidličná ropa atd., tekuté produkty ze zkapalňování uhlí, tekuté produkty z přeměny zemního plynu na benzin, emulgované oleje (např. orimulsion); nezahrnuje ropnou břidlici; zahrnuje břidličnou ropu (druhotný produkt).
...
Topný olej s obsahem síry nižším než 0,5 %.
3.4.18.2. Vysokosirný topný olej (HSFO)
Topný olej s obsahem síry 0,5 % nebo vyšším.
...
3.5.1.2.1. Z toho přečerpávání
Jedná se o část elektřiny vyrobenou v kombinovaných vodních elektrárnách v čerpadlovém vodním režimu (z vody, která byla předtím přečerpána do horní nádrže).
...
3.6. VODÍK
Musí se vykázat vodík použitý jako vstupní surovina, palivo nebo nosič/úložiště energie. Vodík se vykazuje, a to i v případě, kdy se vyrábí a spotřebovává v rámci vlastní spotřeby. Vodík přítomný ve směsích se nevykáže, pokud není extrahován (oddělován) pro energetické nebo neenergetické užití.
PŘÍLOHA B
...
- e) Způsob předávání: Údaje by měly být předány nebo nahrány elektronickými prostředky do jednotného kontaktního místa Eurostatu pro údaje.
...
1.2.5.
1.2.5.1
Neenergetické užití ve všech průmyslových transformačních a energetických subsektorech.
1.2.5.1.1.
Oddíly 20 a 21 NACE; neenergetické užití uhlí zahrnuje použití jako vstupní surovina pro výrobu hnojiv a jako vstupní surovina pro ostatní petrochemické produkty.
1.2.5.2.
...
2.2.1.5.
2.2.1.6.
Počáteční a konečné zásoby by měly být uvedeny zvlášť jako zásoby na území státu a zásoby držené v zahraničí. „Zásobami“ se rozumí množství plynu, jež je k dispozici pro dodávky během každého vstupního-výstupního cyklu.
2.2.1.7.
2.2.1.8.
Jedná se o vytěžitelný zemní plyn skladovaný ve speciálních skladovacích zařízeních (vyčerpaná plynová nebo ropná pole, vodonosné vrstvy, vytěžené solné prostory, smíšené kaverny nebo jiné) a také skladovaný zkapalněný zemní plyn. Neměl by se zahrnovat pracovní polštář. Požadavek na vykazování výhřevnosti se zde neuplatňuje.
2.2.1.9.
...
2.3. Jednotky měření
Množství zemního plynu by se mělo vyjádřit energetickým obsahem, tj. v TJ podle spalného tepla. Pokud se požadují fyzická množství, jednotka se uvádí v 10 6 m 3 za předpokladu referenčních podmínek plynu (15 °C, 101 325 Pa).
Výhřevnost by se měla vykázat v kJ/m 3 za předpokladu referenčních podmínek plynu (15 °C, 101 325 Pa).
Provozní kapacita by měla být uvedena v 10 6 m 3 za předpokladu referenčních podmínek plynu (15 °C, 101 325 Pa).
Špičkový výkon, kapacita pro zpětné zplyňování a pro zkapalňování by měly být uvedeny v 10 6 m 3 /den za předpokladu referenčních podmínek plynu (15 °C, 101 325 Pa).
3. ELEKTŘINA A TEPLO
...
Výhřevnost musí být uvedena v MJ/t (v megajoulech na tunu).
Plocha solárních kolektorů se musí uvést v 1 000 m 2 .
...
7.1.3.8.
7.1.3.10.
7.1.4. PŘENOSOVÉ A DISTRIBUČNÍ ZTRÁTY
7.1.5. KONEČNÁ NEENERGETICKÁ SPOTŘEBA – PRŮMYSL
7.1.5.1.
7.1.5.2.
7.1.5.3.
7.1.5.4.
...
7.1.5.13.
7.1.5.14.
7.1.6. KONEČNÁ SPOTŘEBA ENERGIE – PRŮMYSL
7.1.6.1.
7.1.6.2.
7.1.6.3.
7.1.6.4.
...
7.1.6.12.
7.1.6.13.
7.1.7. KONEČNÁ SPOTŘEBA ENERGIE – SEKTOR DOPRAVY
7.1.7.1.
7.1.7.2.
7.1.7.3.
7.1.7.4.
7.1.7.5.
7.1.7.6.
7.1.8. KONEČNÁ SPOTŘEBA ENERGIE – OSTATNÍ SEKTORY
7.1.8.1.
7.1.8.2.
7.1.8.3.
7.1.8.4.
...
Výrobní kapacita vodíku ke dni 31. prosince referenčního roku se musí vykázat stejně podrobně jako v případě výroby (položky 7.1.1.1. až 7.1.1.1.8.).
7.3. Jednotky měření
Množství se musí vykázat v TJ (výhřevnost) a výrobní kapacita v TJ (výhřevnost) za rok.
...
8.1.3.15.
8.1.3.16.
Vykáží se pouze datová centra provozovaná zpravodajskými jednotkami (bez ohledu na jejich kód NACE) o celkovém výkonu nejméně 1 MW. Poprvé se uvedená položka povinně vykáže v referenčním roce 2024.
...
Výhřevnost u zemního plynu a vyrobených plynů se musí vykázat v kJ/m 3 za předpokladu referenčních podmínek plynu (15 °C, 101 325 Pa).
...
1.2.1.8.
1.2.1.9.
Nezahrnuje černé uhlí spotřebované jako energie pro podpůrné činnosti v koksovnách, vykáže se v položce „Dodávky do průmyslu celkem“.
1.2.1.10.
Zahrnuje černé uhlí dodávané do transformačního sektoru (s výjimkou černého uhlí vykázaného v položce „Dodávky výrobcům s hlavní činností“ a „Dodávky do koksoven“), energetického sektoru a konečnou spotřebu energie z černého uhlí v průmyslu.
1.2.1.10.1.
Zahrnuje černé uhlí vložené do vysoké pece podle definice v příloze A bodě 2.2.11., a konečnou spotřebu energie z černého uhlí v hutnictví železa podle definice v příloze A bodě 2.6.1.8.
Nezahrnuje černé uhlí spotřebované jako energie pro podpůrné činnosti ve vysokých pecích, vykáže se v položce „Dodávky do průmyslu celkem“.
1.2.1.11.
Množství černého uhlí dodané sektorům, které nejsou výslovně uvedeny.
1.2.2.
1.2.2.1.
1.2.2.2.
1.2.2.3.
...
Jedná se o množství u výrobců, dovozců a spotřebitelů, kteří dovážejí přímo.
1.2.3.7.
Zahrnuje černouhelný metalurgický koks vložený do vysoké pece podle definice v příloze A bodě 2.2.11. a konečnou spotřebu energie z černého uhlí v hutnictví železa podle definice v příloze A bodě 2.6.1.8.
Nezahrnuje černouhelný metalurgický koks spotřebovaný jako energie pro podpůrné činnosti ve vysokých pecích.
1.3. Jednotky měření
...
4.2.13. DODÁVKY PRO VÝROBU ELEKTŘINY
4.3. Jednotky měření
...
1.3. Seznam agregátů
1.3.1. U dovozu surové ropy rozděleného podle typu a zeměpisné oblasti, ve které byla vytěžena, by měl být uveden tento seznam agregátů:
1.3.1.1.
1.3.1.2.
1.3.1.3.
1.3.1.4.
1.3.1.5.
1.3.1.6.
1.3.2. U dodávek surové ropy se musí vykázat tento seznam agregátů:
1.3.2.1.
1.3.2.2.
1.4. Jednotky měření
...
$ (americký dolar) za barel u bodu 1.3.1.5. a 1.3.2.2.
$ (americký dolar) za tunu u bodu 1.3.2.2.
