---
citace: 69/2023 Sb.
nazev: Nařízení vlády o stanovení podmínek provádění opatření v odvětví vína
druh: NAŘÍZENÍ VLÁDY
datum: ze dne 8. března 2023
ucinnost_od: 2026-07-01
eli: /eli/cz/sb/2023/69/2026-07-01
rok: 2023
cislo: 69
tags:
  - zakon
...
- b) díl půdního bloku, na kterém má proběhnout vyklučení vinice, je evidován v evidenci na žadatele jako vinice v souladu s registrem vinic4), a to nejpozději v den podání žádosti, a
- c) díl půdního bloku, na kterém je podopatření prováděno, je evidován v evidenci na žadatele jako vinice v souladu s registrem vinic4), a to nejpozději v den podání oznámení o provedení opatření podle odstavce 8.
...
- a) podle § 2 odst. 2 písm. a) může použít pouze povolení pro opětovnou výsadbu5) evidovaná v registru vinic a udělená na základě vyklučení vinice provedeného po kontrole Fondem,
- b) podle § 2 odst. 2 písm. b) může použít pouze povolení pro opětovnou výsadbu5) evidovaná v registru vinic a udělená na základě vyklučení vinice provedeného podle žádosti po kontrole Fondem, nebo
- c) podle § 2 odst. 2 písm. c) může použít pouze povolení pro opětovnou výsadbu5) evidovaná v registru vinic a udělená na základě vyklučení vinice provedeného po kontrole Fondem, která ověřila počet keřů révy vinné.
...
- d) výsadba se provede moštovou odrůdou7) registrovanou v České republice nebo v jiném členském státě Evropské unie při počtu keřů nejméně 4 000 kusů na 1 ha osázené plochy vinice.
...
- b) výměra osázené plochy nebo součet plochy takto restrukturalizovaných vinic žadatele neklesne pod 0,2 ha,
- c) se výsadba nebo dosadba provede moštovou odrůdou7) registrovanou v České republice nebo v jiném členském státě Evropské unie při počtu keřů nejméně 4 273 kusů na 1 ha osázené plochy vinice a
...
- a) popis pořízeného zařízení podle odstavce 2 a uvedení jeho přínosu ke zvýšení výkonnosti podniku10),
...
(5) Žadatel musí investici provést nejdříve po podání žádosti podle odstavce 1 a dodat Fondu doklady o její úhradě do 31. ledna kalendářního roku následujícího po podání žádosti, a to včetně cenové nabídky a vyhodnocení průzkumu trhu k jednotlivým investicím.
