...
(1) Za hrubý výdělek pracujícího, který se připravuje k výkonu povolání zaškolením6) se považuje částka 1400 Kčs měsíčně, pokud skutečný hrubý výdělek z výkonu zaměstnání není vyšší.
...
## § 60
**„Žáci a studenti**
(1) Za hrubý výdělek žáka a studenta se považuje částka 1400 Kčs měsíčně. Náleží-li žáku nebo studentu odměna86) nebo hrubý výdělek ze zaměstnání v některém měsíci vyšší, považuje se za jeho výdělek v tomto měsíci skutečně dosažený hrubý výdělek (odměna).
