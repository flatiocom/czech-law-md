---
citace: 69/2004 Sb.
nazev: Vyhláška, kterou se stanoví požadavky na napínací soupravy na předpjatý beton
druh: VYHLÁŠKA
...
TřídaRelativníRozšířená nejistota kalibrační sílychybaodchylka reprodukovatelnostiodchylka opakovatelnostiodchylka interpolaceqbb´faWbmc%3331,520,455552,52,50,45
...
Třída napínací soupravyEtalonový siloměr použitý ke kalibraciTřída etalonového siloměruNejvětší hodnota rozšířené nejistoty kalibrace siloměru%31± 0,2451 nebo 2± 0,45
...
b´=X1–X2X¯∙100,
kdeb´ je relativní hodnota odchylky opakovantelnosti%X1hodnota tlaku při 1. řadě uměření(MPa)X2hodnota tlaku při 2. řadě měření(MPa)X¯střední hodnota při nezměněné poloze etalonového siloměru(MPa)
...
b=X3–XlX¯∙100,
kdeb je relativní hodnota odchylky reprodukovatelnosti%X3hodnota tlaku oleje po pootočení siloměru o 90o(MPa)Xlhodnota tlaku oleje při první řade měření(MPa)X¯střední hodnota při změně polohy siloměru(MPa)
...
fa=X¯-XaX¯∙100,
kdefaje relativní odchylka interpolace%X¯Střední hodnota údaje tlaku oleje(MPa)Xateoretická hodnota vypočtená z interpolační rovnice(MPa)
...
**Parametr****Rozdělení standardní nejistot a typu****Relativní odchylky****Relativní hodnota standardní nejistoty**Relativní odchylka opakovatelnostiTyp B pravoúhlé rozděleníab´=b´2wrep=b´12Relativní odchylka reprodukovatelnostiTyp B U rozděleníab=b2wrot=b8Relativní odchylka interpolaceTyp B trojúhelníkové rozděleníaa = fawint=fa6Relativní rozlišovací schopnostTyp B pravoúhlé rozděleníar=r2wres=r12Relativní standardní nejistota etalonového síloměruaF=UF2wF=Wbmc2Relativní standardní nejistota etalonového manometruaEp=UEp2wEp=WEp2Relativní standardní nejistota pracovního manometruaPp=UPp2wPp=WPp2
