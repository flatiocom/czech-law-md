...
- a) provádět hornické činnosti a činnosti prováděné hornickým způsobem1) a zásahy trvale narušující skalní podklad; jde-li o práce a úpravy nutné v zájmu ochrany a využívání zdrojů, postupuje se podle § 37 lázeňského zákona,
- b) zřizovat vrty pro získání tepelné energie,
- c) provádět trhací práce1),
- d) aplikovat hnojiva s rychle uvolnitelným dusíkem2),
- e) zřizovat a provozovat skládky odpadů všeho druhu, zřizovat a provozovat zařízení k využívání odpadů, k úpravě odpadů a nebo ke sběru a výkupu odpadů3),
- f) vypouštět odpadní vody do vod podzemních4),
- g) provádět činnosti, které mají vliv na minimální hladiny podzemních vod5),
- h) zřizovat kafilerie, jatka, spalovny odpadů,
- i) budovat produktovody závadných látek4),
...
- l) provozovat intenzivní chov hospodářských zvířat a zvěře6),
