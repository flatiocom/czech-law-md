---
citace: 157/2005 Sb.
nazev: Vyhláška o náležitostech přihlášky ke zkoušce k prokázání odborné způsobilosti k obsluze vysílacích rádiových zařízení, o rozsahu znalostí potřebných pro jednotlivé druhy odborné způsobilosti, o způsobu provádění zkoušek, o druzích průkazů odborné způsobilosti a době jejich platnosti
druh: VYHLÁŠKA
...
- c) letadlovou stanicí pohyblivá stanice letecké pohyblivé služby jiná než stanice záchranného prostředku umístěná na palubě letadla. Za umístění na palubě letadla se považuje též jiné umístění stanice, které umožňuje její použití pro komunikaci dálkově řídícího pilota bezpilotního letadla6),
...
- f) letadlovou pozemskou stanicí pohyblivá pozemská stanice družicové letecké pohyblivé služby umístěná na palubě letadla. Za umístění na palubě letadla se považuje též jiné umístění stanice, které umožňuje její použití pro komunikaci dálkově řídícího pilota bezpilotního letadla6),
