---
citace: 10/1974 Sb.
nazev: Vyhláška Českého úřadu geodetického a kartografického o geodetických pracích ve výstavbě
druh: VYHLÁŠKA
datum: ze dne 31. ledna 1974
...
(1) Účastníci výstavby jsou povinni (§ 4-6) zajistit výkon geodetických prací odpovědnými geodety. Jde-li o stavby, které vyžadují pouze jednoduché geodetické práce, může krajská geodetická a kartografická správa5) příslušná podle místa konání prací po předchozím vyjádření stavebního úřadu rozhodnout, že odborný výkon geodetických prací může být účastníky výstavby zajištěn kvalifikovanými pracovníky bez jmenování odpovědných geodetů.
