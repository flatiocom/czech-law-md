...
- 2. § 4 odst. 1 zní:
„(1) Základní příspěvek činí 11 100 Kčs na každý byt bez zřetele k jeho velikosti a 1200 Kčs na každý m2 skutečné užitkové plochy6) bytů v domě do výměry 85 m2 u jednotlivých bytů (dále jen „užitková plocha“).“.
- 3. § 5 odst. 1 a 5 zní:
...
(5) Provádí-li se výstavba družstevních bytů v objektech splňujících podmínky níže uvedených stavebních soustav8) (dále jen „objekty“), poskytne se vedle zvláštního příspěvku podle předcházejících odstavců na každý m2 užitkové plochy ještě zvláštní příspěvek ve výši
