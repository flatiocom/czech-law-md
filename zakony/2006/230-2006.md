---
citace: 230/2006 Sb.
nazev: Zákon, kterým se mění zákon č. 89/1995 Sb., o státní statistické službě, ve znění pozdějších předpisů, a další související zákony
druh: ZÁKON
...
- b) z údajů získaných v celním řízení5) o přidělení celně schváleného určení, údaje stanovené přímo použitelným předpisem Evropských společenství4d),
...
- 17. V § 17 odst. 2 větě první se za slova „statistickému účelu,“ vkládají slova „pokud tak stanoví zvláštní zákon7), nebo“.
...
- 26. V § 20 odst. 8 se věta první nahrazuje větou „Údaje uvedené v odstavci 2 písm. k) až t), odstavci 4 o činnostních jednotkách, v odstavci 4 písm. i) a j) o místních jednotkách a v odstavci 5 písm. b) a c) jsou neveřejné, pokud zvláštní zákon nestanoví jinak9e).“.
...
(5) Pro účely tohoto registru tvoří
  - a) soustavu územních prvků: oblast, kraj, okres, obec, městský obvod, resp. městská část, základní územní jednotka, katastrální území9i), územně technická jednotka, základní sídelní jednotka, statistický obvod a parcela9i),
...
- 32. V § 21 se na konci textu odstavce 2 doplňují slova „; to neplatí, dojde-li k přeměně ekonomického subjektu ze zákona nebo změně právní formy společnosti9k) nebo družstva9k)“.
...
- „d) právnickým osobám registrovaným nebo evidovaným podle zvláštního právního předpisu11c) Ministerstvo kultury,
...
- 4. V § 5 odst. 10 se věta poslední nahrazuje větou „Pokuty se vymáhají podle zvláštního právního předpisu5f).“.
