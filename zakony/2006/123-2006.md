---
citace: 123/2006 Sb.
nazev: Vyhláška o evidenci a dokumentaci návykových látek a přípravků
druh: VYHLÁŠKA
...
- c) záznamy o provedení inventury z inventur podle § 4 včetně inventurních protokolů z inventur prováděných podle zvláštního právního předpisu7),
...
- a) první průpisy receptů8) a žádanek9) s modrým pruhem, případně i první listy receptů8) s modrým pruhem (§ 13 odst. 4 zákona), jde-li o přípravky hrazené pacientem,
...
(1) Dokumentace se uchovává tak, aby se zabránilo jejímu znehodnocení, ztrátě, poškození, zničení, zneužití nebo odcizení. Pokud se jedná o uchovávání osobních údajů, postupuje se podle zvláštního právního předpisu11).
