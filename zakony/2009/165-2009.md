---
citace: 165/2009 Sb.
nazev: Vyhláška o stanovení seznamu vybraných položek v jaderné oblasti
druh: VYHLÁŠKA
...
- 5.4.3.1.Speciálně konstruované nebo upravené rozsáhlé vakuové kolektory, sběrná potrubí a vakuová čerpadla se sacím výkonem 5 m3/min (175 ft3/min) nebo větším.
...
- 5.5.9.1.Speciálně konstruované nebo upravené vakuové systémy s minimálním sacím výkonem 5 m3/min, sestávající z vakuového sběrného potrubí, vakuových sběračů (kolektorů) a vakuových vývěv, projektovaných pro provoz v prostředí obsahujícím UF6.
