...
eli: /eli/cz/sb/2008/391/0000-00-00
rok: 2008
cislo: 391
tags:
  - zakon
...
- d) obecní úřady, v hlavním městě Praze a ve městech Brno, Ostrava a Plzeň úřady městských částí nebo městských obvodů, pokud tak stanoví statuty těchto měst, a na území vojenských újezdů újezdní úřady4), (dále jen „ohlašovna“).

#### § 3
**Informační systém evidence obyvatel**
(1) Evidence obyvatel je vedena v informačnímsystému evidence obyvatel (dále jen „informační systém“), jehož správcem5) je ministerstvo. Tento informační systém je informačním systémem veřejné správy podle zvláštního zákona5a).
...
- b) místem uzavření manželství nebo vzniku registrovaného partnerství (dále jen „partnerství“)5d) obec nebo vojenský újezd, v hlavním městě Praze obvod Praha 1 až 105d), na jehož území došlo k uzavření manželství nebo partnerství obyvatele,
...
- j) zákaz pobytu5e), místo zákazu pobytu a doba jeho trvání,
...
(4) V informačním systému se o cizincích s povolením k pobytu na území České republiky podle zvláštního právního předpisu2) a o cizincích, kterým byla na území České republiky udělena mezinárodní ochrana formou azylu nebo doplňkové ochrany3), vedou tyto údaje:
- a) jméno, popřípadě jména, příjmení, rodné příjmení,
- b) datum narození,
- c) pohlaví,
...
- r) vyhoštění5o) a doba, po kterou není umožněn vstup na území České republiky,
...
- 15. vyhoštění5o) a doba, po kterou není umožněn vstup na území České republiky,
...
(2) Při archivování dokumentace související s vedením informačního systému se postupuje podle zvláštního právního předpisu10).
...
(5) Pokud není v odstavci 3 stanoveno jinak, vztahuje se na přestupky a jejich projednávání zákon o přestupcích14d).
