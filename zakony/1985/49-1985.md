---
citace: 49/1985 Sb.
nazev: Vyhláška Federálního statistického úřadu o základních podmínkách dodávky prací a služeb v oblasti automatizovaného zpracování dat
druh: VYHLÁŠKA
datum: ze dne 5. června 1985
...
- a) k provedení prací spojených s vypracováním projektové dokumentace1) automatizovaných systémů2) a její poskytování jiným uživatelům (dále jen „vypracování projektové dokumentace“),
- b) k provedení prací a služeb spojených s automatizovaným zpracováním dat,3)
- c) k poskytnutí dat z datové základny4) dodavatele (dále jen „poskytování výstupních dat“),
