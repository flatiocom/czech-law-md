---
citace: 302/2010 Sb.
nazev: Vyhláška o předkládání výkazů a dalších informací penzijními fondy České národní bance pro účely dohledu
druh: VYHLÁŠKA
datum: ze dne 13. října 2010
...
---
> [!danger] Zrušeno
> Tento předpis byl zrušen k 2013-01-01 předpisem 425/2012 Sb. a **nelze podle něj postupovat**.
> Zůstává tu kvůli posouzení právních vztahů vzniklých v době jeho účinnosti.

# 302/2010 Sb.

*o předkládání výkazů a dalších informací penzijními fondy České národní bance pro účely dohledu*
...
(2) Vykazující subjekt postupuje při sestavování předkládaných výkazů přiměřeně k jejich povaze v souladu s právními předpisy upravujícími vedení účetnictví a sestavování účetní závěrky1) nebo s mezinárodními účetními standardy upravenými právem Evropské unie2).
...
(1) Vykazující subjekt předkládá České národní bance výroční zprávu3) v elektronické podobě stanovené právním předpisem o digitalizaci obchodního rejstříku4), a to nejpozději do konce 7. měsíce po skončení období, k němuž se vztahuje. Výroční zpráva v elektronické podobě podepsaná zaručeným elektronickým podpisem5) založeným na kvalifikovaném certifikátu vydaném akreditovaným poskytovatelem certifikačních služeb je předkládána na adresu elektronické podatelny České národní banky nebo prostřednictvím veřejné datové sítě do datové schránky6).
